...
newAbortIncompleteMultipartUpload' :: ( { "DaysAfterInitiation" :: NullOrUndefined.NullOrUndefined (DaysAfterInitiation) } -> {"DaysAfterInitiation" :: NullOrUndefined.NullOrUndefined (DaysAfterInitiation) } ) -> AbortIncompleteMultipartUpload
...
--   This may be useful if you need to immediately overwrite some of the optional values
newAbortMultipartUploadOutput' :: ( { "RequestCharged" :: NullOrUndefined.NullOrUndefined (RequestCharged) } -> {"RequestCharged" :: NullOrUndefined.NullOrUndefined (RequestCharged) } ) -> AbortMultipartUploadOutput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newAbortMultipartUploadRequest' :: BucketName -> ObjectKey -> MultipartUploadId -> ( { "Bucket" :: (BucketName) , "Key" :: (ObjectKey) , "UploadId" :: (MultipartUploadId) , "RequestPayer" :: NullOrUndefined.NullOrUndefined (RequestPayer) } -> {"Bucket" :: (BucketName) , "Key" :: (ObjectKey) , "UploadId" :: (MultipartUploadId) , "RequestPayer" :: NullOrUndefined.NullOrUndefined (RequestPayer) } ) -> AbortMultipartUploadRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newAccelerateConfiguration' :: ( { "Status" :: NullOrUndefined.NullOrUndefined (BucketAccelerateStatus) } -> {"Status" :: NullOrUndefined.NullOrUndefined (BucketAccelerateStatus) } ) -> AccelerateConfiguration
...
--   This may be useful if you need to immediately overwrite some of the optional values
newAccessControlPolicy' :: ( { "Grants" :: NullOrUndefined.NullOrUndefined (Grants) , "Owner" :: NullOrUndefined.NullOrUndefined (Owner) } -> {"Grants" :: NullOrUndefined.NullOrUndefined (Grants) , "Owner" :: NullOrUndefined.NullOrUndefined (Owner) } ) -> AccessControlPolicy
...
--   This may be useful if you need to immediately overwrite some of the optional values
newAnalyticsAndOperator' :: ( { "Prefix" :: NullOrUndefined.NullOrUndefined (Prefix) , "Tags" :: NullOrUndefined.NullOrUndefined (TagSet) } -> {"Prefix" :: NullOrUndefined.NullOrUndefined (Prefix) , "Tags" :: NullOrUndefined.NullOrUndefined (TagSet) } ) -> AnalyticsAndOperator
...
--   This may be useful if you need to immediately overwrite some of the optional values
newAnalyticsConfiguration' :: AnalyticsId -> StorageClassAnalysis -> ( { "Id" :: (AnalyticsId) , "Filter" :: NullOrUndefined.NullOrUndefined (AnalyticsFilter) , "StorageClassAnalysis" :: (StorageClassAnalysis) } -> {"Id" :: (AnalyticsId) , "Filter" :: NullOrUndefined.NullOrUndefined (AnalyticsFilter) , "StorageClassAnalysis" :: (StorageClassAnalysis) } ) -> AnalyticsConfiguration
...
--   This may be useful if you need to immediately overwrite some of the optional values
newAnalyticsFilter' :: ( { "Prefix" :: NullOrUndefined.NullOrUndefined (Prefix) , "Tag" :: NullOrUndefined.NullOrUndefined (Tag) , "And" :: NullOrUndefined.NullOrUndefined (AnalyticsAndOperator) } -> {"Prefix" :: NullOrUndefined.NullOrUndefined (Prefix) , "Tag" :: NullOrUndefined.NullOrUndefined (Tag) , "And" :: NullOrUndefined.NullOrUndefined (AnalyticsAndOperator) } ) -> AnalyticsFilter
...
--   This may be useful if you need to immediately overwrite some of the optional values
newAnalyticsS3BucketDestination' :: BucketName -> AnalyticsS3ExportFileFormat -> ( { "Format" :: (AnalyticsS3ExportFileFormat) , "BucketAccountId" :: NullOrUndefined.NullOrUndefined (AccountId) , "Bucket" :: (BucketName) , "Prefix" :: NullOrUndefined.NullOrUndefined (Prefix) } -> {"Format" :: (AnalyticsS3ExportFileFormat) , "BucketAccountId" :: NullOrUndefined.NullOrUndefined (AccountId) , "Bucket" :: (BucketName) , "Prefix" :: NullOrUndefined.NullOrUndefined (Prefix) } ) -> AnalyticsS3BucketDestination
...
--   This may be useful if you need to immediately overwrite some of the optional values
newBucket' :: ( { "Name" :: NullOrUndefined.NullOrUndefined (BucketName) , "CreationDate" :: NullOrUndefined.NullOrUndefined (CreationDate) } -> {"Name" :: NullOrUndefined.NullOrUndefined (BucketName) , "CreationDate" :: NullOrUndefined.NullOrUndefined (CreationDate) } ) -> Bucket
...
--   This may be useful if you need to immediately overwrite some of the optional values
newBucketLoggingStatus' :: ( { "LoggingEnabled" :: NullOrUndefined.NullOrUndefined (LoggingEnabled) } -> {"LoggingEnabled" :: NullOrUndefined.NullOrUndefined (LoggingEnabled) } ) -> BucketLoggingStatus
...
--   This may be useful if you need to immediately overwrite some of the optional values
newCORSRule' :: AllowedMethods -> AllowedOrigins -> ( { "AllowedHeaders" :: NullOrUndefined.NullOrUndefined (AllowedHeaders) , "AllowedMethods" :: (AllowedMethods) , "AllowedOrigins" :: (AllowedOrigins) , "ExposeHeaders" :: NullOrUndefined.NullOrUndefined (ExposeHeaders) , "MaxAgeSeconds" :: NullOrUndefined.NullOrUndefined (MaxAgeSeconds) } -> {"AllowedHeaders" :: NullOrUndefined.NullOrUndefined (AllowedHeaders) , "AllowedMethods" :: (AllowedMethods) , "AllowedOrigins" :: (AllowedOrigins) , "ExposeHeaders" :: NullOrUndefined.NullOrUndefined (ExposeHeaders) , "MaxAgeSeconds" :: NullOrUndefined.NullOrUndefined (MaxAgeSeconds) } ) -> CORSRule
...
--   This may be useful if you need to immediately overwrite some of the optional values
newCSVInput' :: ( { "FileHeaderInfo" :: NullOrUndefined.NullOrUndefined (FileHeaderInfo) , "Comments" :: NullOrUndefined.NullOrUndefined (Comments) , "QuoteEscapeCharacter" :: NullOrUndefined.NullOrUndefined (QuoteEscapeCharacter) , "RecordDelimiter" :: NullOrUndefined.NullOrUndefined (RecordDelimiter) , "FieldDelimiter" :: NullOrUndefined.NullOrUndefined (FieldDelimiter) , "QuoteCharacter" :: NullOrUndefined.NullOrUndefined (QuoteCharacter) } -> {"FileHeaderInfo" :: NullOrUndefined.NullOrUndefined (FileHeaderInfo) , "Comments" :: NullOrUndefined.NullOrUndefined (Comments) , "QuoteEscapeCharacter" :: NullOrUndefined.NullOrUndefined (QuoteEscapeCharacter) , "RecordDelimiter" :: NullOrUndefined.NullOrUndefined (RecordDelimiter) , "FieldDelimiter" :: NullOrUndefined.NullOrUndefined (FieldDelimiter) , "QuoteCharacter" :: NullOrUndefined.NullOrUndefined (QuoteCharacter) } ) -> CSVInput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newCSVOutput' :: ( { "QuoteFields" :: NullOrUndefined.NullOrUndefined (QuoteFields) , "QuoteEscapeCharacter" :: NullOrUndefined.NullOrUndefined (QuoteEscapeCharacter) , "RecordDelimiter" :: NullOrUndefined.NullOrUndefined (RecordDelimiter) , "FieldDelimiter" :: NullOrUndefined.NullOrUndefined (FieldDelimiter) , "QuoteCharacter" :: NullOrUndefined.NullOrUndefined (QuoteCharacter) } -> {"QuoteFields" :: NullOrUndefined.NullOrUndefined (QuoteFields) , "QuoteEscapeCharacter" :: NullOrUndefined.NullOrUndefined (QuoteEscapeCharacter) , "RecordDelimiter" :: NullOrUndefined.NullOrUndefined (RecordDelimiter) , "FieldDelimiter" :: NullOrUndefined.NullOrUndefined (FieldDelimiter) , "QuoteCharacter" :: NullOrUndefined.NullOrUndefined (QuoteCharacter) } ) -> CSVOutput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newCloudFunctionConfiguration' :: ( { "Id" :: NullOrUndefined.NullOrUndefined (NotificationId) , "Event" :: NullOrUndefined.NullOrUndefined (Event) , "Events" :: NullOrUndefined.NullOrUndefined (EventList) , "CloudFunction" :: NullOrUndefined.NullOrUndefined (CloudFunction) , "InvocationRole" :: NullOrUndefined.NullOrUndefined (CloudFunctionInvocationRole) } -> {"Id" :: NullOrUndefined.NullOrUndefined (NotificationId) , "Event" :: NullOrUndefined.NullOrUndefined (Event) , "Events" :: NullOrUndefined.NullOrUndefined (EventList) , "CloudFunction" :: NullOrUndefined.NullOrUndefined (CloudFunction) , "InvocationRole" :: NullOrUndefined.NullOrUndefined (CloudFunctionInvocationRole) } ) -> CloudFunctionConfiguration
...
--   This may be useful if you need to immediately overwrite some of the optional values
newCommonPrefix' :: ( { "Prefix" :: NullOrUndefined.NullOrUndefined (Prefix) } -> {"Prefix" :: NullOrUndefined.NullOrUndefined (Prefix) } ) -> CommonPrefix
...
--   This may be useful if you need to immediately overwrite some of the optional values
newCompleteMultipartUploadOutput' :: ( { "Location" :: NullOrUndefined.NullOrUndefined (Location) , "Bucket" :: NullOrUndefined.NullOrUndefined (BucketName) , "Key" :: NullOrUndefined.NullOrUndefined (ObjectKey) , "Expiration" :: NullOrUndefined.NullOrUndefined (Expiration) , "ETag" :: NullOrUndefined.NullOrUndefined (ETag) , "ServerSideEncryption" :: NullOrUndefined.NullOrUndefined (ServerSideEncryption) , "VersionId" :: NullOrUndefined.NullOrUndefined (ObjectVersionId) , "SSEKMSKeyId" :: NullOrUndefined.NullOrUndefined (SSEKMSKeyId) , "RequestCharged" :: NullOrUndefined.NullOrUndefined (RequestCharged) } -> {"Location" :: NullOrUndefined.NullOrUndefined (Location) , "Bucket" :: NullOrUndefined.NullOrUndefined (BucketName) , "Key" :: NullOrUndefined.NullOrUndefined (ObjectKey) , "Expiration" :: NullOrUndefined.NullOrUndefined (Expiration) , "ETag" :: NullOrUndefined.NullOrUndefined (ETag) , "ServerSideEncryption" :: NullOrUndefined.NullOrUndefined (ServerSideEncryption) , "VersionId" :: NullOrUndefined.NullOrUndefined (ObjectVersionId) , "SSEKMSKeyId" :: NullOrUndefined.NullOrUndefined (SSEKMSKeyId) , "RequestCharged" :: NullOrUndefined.NullOrUndefined (RequestCharged) } ) -> CompleteMultipartUploadOutput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newCompleteMultipartUploadRequest' :: BucketName -> ObjectKey -> MultipartUploadId -> ( { "Bucket" :: (BucketName) , "Key" :: (ObjectKey) , "MultipartUpload" :: NullOrUndefined.NullOrUndefined (CompletedMultipartUpload) , "UploadId" :: (MultipartUploadId) , "RequestPayer" :: NullOrUndefined.NullOrUndefined (RequestPayer) } -> {"Bucket" :: (BucketName) , "Key" :: (ObjectKey) , "MultipartUpload" :: NullOrUndefined.NullOrUndefined (CompletedMultipartUpload) , "UploadId" :: (MultipartUploadId) , "RequestPayer" :: NullOrUndefined.NullOrUndefined (RequestPayer) } ) -> CompleteMultipartUploadRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newCompletedMultipartUpload' :: ( { "Parts" :: NullOrUndefined.NullOrUndefined (CompletedPartList) } -> {"Parts" :: NullOrUndefined.NullOrUndefined (CompletedPartList) } ) -> CompletedMultipartUpload
...
--   This may be useful if you need to immediately overwrite some of the optional values
newCompletedPart' :: ( { "ETag" :: NullOrUndefined.NullOrUndefined (ETag) , "PartNumber" :: NullOrUndefined.NullOrUndefined (PartNumber) } -> {"ETag" :: NullOrUndefined.NullOrUndefined (ETag) , "PartNumber" :: NullOrUndefined.NullOrUndefined (PartNumber) } ) -> CompletedPart
...
--   This may be useful if you need to immediately overwrite some of the optional values
newCondition' :: ( { "HttpErrorCodeReturnedEquals" :: NullOrUndefined.NullOrUndefined (HttpErrorCodeReturnedEquals) , "KeyPrefixEquals" :: NullOrUndefined.NullOrUndefined (KeyPrefixEquals) } -> {"HttpErrorCodeReturnedEquals" :: NullOrUndefined.NullOrUndefined (HttpErrorCodeReturnedEquals) , "KeyPrefixEquals" :: NullOrUndefined.NullOrUndefined (KeyPrefixEquals) } ) -> Condition
...
--   This may be useful if you need to immediately overwrite some of the optional values
newCopyObjectOutput' :: ( { "CopyObjectResult" :: NullOrUndefined.NullOrUndefined (CopyObjectResult) , "Expiration" :: NullOrUndefined.NullOrUndefined (Expiration) , "CopySourceVersionId" :: NullOrUndefined.NullOrUndefined (CopySourceVersionId) , "VersionId" :: NullOrUndefined.NullOrUndefined (ObjectVersionId) , "ServerSideEncryption" :: NullOrUndefined.NullOrUndefined (ServerSideEncryption) , "SSECustomerAlgorithm" :: NullOrUndefined.NullOrUndefined (SSECustomerAlgorithm) , "SSECustomerKeyMD5" :: NullOrUndefined.NullOrUndefined (SSECustomerKeyMD5) , "SSEKMSKeyId" :: NullOrUndefined.NullOrUndefined (SSEKMSKeyId) , "RequestCharged" :: NullOrUndefined.NullOrUndefined (RequestCharged) } -> {"CopyObjectResult" :: NullOrUndefined.NullOrUndefined (CopyObjectResult) , "Expiration" :: NullOrUndefined.NullOrUndefined (Expiration) , "CopySourceVersionId" :: NullOrUndefined.NullOrUndefined (CopySourceVersionId) , "VersionId" :: NullOrUndefined.NullOrUndefined (ObjectVersionId) , "ServerSideEncryption" :: NullOrUndefined.NullOrUndefined (ServerSideEncryption) , "SSECustomerAlgorithm" :: NullOrUndefined.NullOrUndefined (SSECustomerAlgorithm) , "SSECustomerKeyMD5" :: NullOrUndefined.NullOrUndefined (SSECustomerKeyMD5) , "SSEKMSKeyId" :: NullOrUndefined.NullOrUndefined (SSEKMSKeyId) , "RequestCharged" :: NullOrUndefined.NullOrUndefined (RequestCharged) } ) -> CopyObjectOutput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newCopyObjectRequest' :: BucketName -> CopySource -> ObjectKey -> ( { "ACL" :: NullOrUndefined.NullOrUndefined (ObjectCannedACL) , "Bucket" :: (BucketName) , "CacheControl" :: NullOrUndefined.NullOrUndefined (CacheControl) , "ContentDisposition" :: NullOrUndefined.NullOrUndefined (ContentDisposition) , "ContentEncoding" :: NullOrUndefined.NullOrUndefined (ContentEncoding) , "ContentLanguage" :: NullOrUndefined.NullOrUndefined (ContentLanguage) , "ContentType" :: NullOrUndefined.NullOrUndefined (ContentType) , "CopySource" :: (CopySource) , "CopySourceIfMatch" :: NullOrUndefined.NullOrUndefined (CopySourceIfMatch) , "CopySourceIfModifiedSince" :: NullOrUndefined.NullOrUndefined (CopySourceIfModifiedSince) , "CopySourceIfNoneMatch" :: NullOrUndefined.NullOrUndefined (CopySourceIfNoneMatch) , "CopySourceIfUnmodifiedSince" :: NullOrUndefined.NullOrUndefined (CopySourceIfUnmodifiedSince) , "Expires" :: NullOrUndefined.NullOrUndefined (Expires) , "GrantFullControl" :: NullOrUndefined.NullOrUndefined (GrantFullControl) , "GrantRead" :: NullOrUndefined.NullOrUndefined (GrantRead) , "GrantReadACP" :: NullOrUndefined.NullOrUndefined (GrantReadACP) , "GrantWriteACP" :: NullOrUndefined.NullOrUndefined (GrantWriteACP) , "Key" :: (ObjectKey) , "Metadata" :: NullOrUndefined.NullOrUndefined (Metadata) , "MetadataDirective" :: NullOrUndefined.NullOrUndefined (MetadataDirective) , "TaggingDirective" :: NullOrUndefined.NullOrUndefined (TaggingDirective) , "ServerSideEncryption" :: NullOrUndefined.NullOrUndefined (ServerSideEncryption) , "StorageClass" :: NullOrUndefined.NullOrUndefined (StorageClass) , "WebsiteRedirectLocation" :: NullOrUndefined.NullOrUndefined (WebsiteRedirectLocation) , "SSECustomerAlgorithm" :: NullOrUndefined.NullOrUndefined (SSECustomerAlgorithm) , "SSECustomerKey" :: NullOrUndefined.NullOrUndefined (SSECustomerKey) , "SSECustomerKeyMD5" :: NullOrUndefined.NullOrUndefined (SSECustomerKeyMD5) , "SSEKMSKeyId" :: NullOrUndefined.NullOrUndefined (SSEKMSKeyId) , "CopySourceSSECustomerAlgorithm" :: NullOrUndefined.NullOrUndefined (CopySourceSSECustomerAlgorithm) , "CopySourceSSECustomerKey" :: NullOrUndefined.NullOrUndefined (CopySourceSSECustomerKey) , "CopySourceSSECustomerKeyMD5" :: NullOrUndefined.NullOrUndefined (CopySourceSSECustomerKeyMD5) , "RequestPayer" :: NullOrUndefined.NullOrUndefined (RequestPayer) , "Tagging" :: NullOrUndefined.NullOrUndefined (TaggingHeader) } -> {"ACL" :: NullOrUndefined.NullOrUndefined (ObjectCannedACL) , "Bucket" :: (BucketName) , "CacheControl" :: NullOrUndefined.NullOrUndefined (CacheControl) , "ContentDisposition" :: NullOrUndefined.NullOrUndefined (ContentDisposition) , "ContentEncoding" :: NullOrUndefined.NullOrUndefined (ContentEncoding) , "ContentLanguage" :: NullOrUndefined.NullOrUndefined (ContentLanguage) , "ContentType" :: NullOrUndefined.NullOrUndefined (ContentType) , "CopySource" :: (CopySource) , "CopySourceIfMatch" :: NullOrUndefined.NullOrUndefined (CopySourceIfMatch) , "CopySourceIfModifiedSince" :: NullOrUndefined.NullOrUndefined (CopySourceIfModifiedSince) , "CopySourceIfNoneMatch" :: NullOrUndefined.NullOrUndefined (CopySourceIfNoneMatch) , "CopySourceIfUnmodifiedSince" :: NullOrUndefined.NullOrUndefined (CopySourceIfUnmodifiedSince) , "Expires" :: NullOrUndefined.NullOrUndefined (Expires) , "GrantFullControl" :: NullOrUndefined.NullOrUndefined (GrantFullControl) , "GrantRead" :: NullOrUndefined.NullOrUndefined (GrantRead) , "GrantReadACP" :: NullOrUndefined.NullOrUndefined (GrantReadACP) , "GrantWriteACP" :: NullOrUndefined.NullOrUndefined (GrantWriteACP) , "Key" :: (ObjectKey) , "Metadata" :: NullOrUndefined.NullOrUndefined (Metadata) , "MetadataDirective" :: NullOrUndefined.NullOrUndefined (MetadataDirective) , "TaggingDirective" :: NullOrUndefined.NullOrUndefined (TaggingDirective) , "ServerSideEncryption" :: NullOrUndefined.NullOrUndefined (ServerSideEncryption) , "StorageClass" :: NullOrUndefined.NullOrUndefined (StorageClass) , "WebsiteRedirectLocation" :: NullOrUndefined.NullOrUndefined (WebsiteRedirectLocation) , "SSECustomerAlgorithm" :: NullOrUndefined.NullOrUndefined (SSECustomerAlgorithm) , "SSECustomerKey" :: NullOrUndefined.NullOrUndefined (SSECustomerKey) , "SSECustomerKeyMD5" :: NullOrUndefined.NullOrUndefined (SSECustomerKeyMD5) , "SSEKMSKeyId" :: NullOrUndefined.NullOrUndefined (SSEKMSKeyId) , "CopySourceSSECustomerAlgorithm" :: NullOrUndefined.NullOrUndefined (CopySourceSSECustomerAlgorithm) , "CopySourceSSECustomerKey" :: NullOrUndefined.NullOrUndefined (CopySourceSSECustomerKey) , "CopySourceSSECustomerKeyMD5" :: NullOrUndefined.NullOrUndefined (CopySourceSSECustomerKeyMD5) , "RequestPayer" :: NullOrUndefined.NullOrUndefined (RequestPayer) , "Tagging" :: NullOrUndefined.NullOrUndefined (TaggingHeader) } ) -> CopyObjectRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newCopyObjectResult' :: ( { "ETag" :: NullOrUndefined.NullOrUndefined (ETag) , "LastModified" :: NullOrUndefined.NullOrUndefined (LastModified) } -> {"ETag" :: NullOrUndefined.NullOrUndefined (ETag) , "LastModified" :: NullOrUndefined.NullOrUndefined (LastModified) } ) -> CopyObjectResult
...
--   This may be useful if you need to immediately overwrite some of the optional values
newCopyPartResult' :: ( { "ETag" :: NullOrUndefined.NullOrUndefined (ETag) , "LastModified" :: NullOrUndefined.NullOrUndefined (LastModified) } -> {"ETag" :: NullOrUndefined.NullOrUndefined (ETag) , "LastModified" :: NullOrUndefined.NullOrUndefined (LastModified) } ) -> CopyPartResult
...
--   This may be useful if you need to immediately overwrite some of the optional values
newCreateBucketConfiguration' :: ( { "LocationConstraint" :: NullOrUndefined.NullOrUndefined (BucketLocationConstraint) } -> {"LocationConstraint" :: NullOrUndefined.NullOrUndefined (BucketLocationConstraint) } ) -> CreateBucketConfiguration
...
--   This may be useful if you need to immediately overwrite some of the optional values
newCreateBucketOutput' :: ( { "Location" :: NullOrUndefined.NullOrUndefined (Location) } -> {"Location" :: NullOrUndefined.NullOrUndefined (Location) } ) -> CreateBucketOutput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newCreateBucketRequest' :: BucketName -> ( { "ACL" :: NullOrUndefined.NullOrUndefined (BucketCannedACL) , "Bucket" :: (BucketName) , "CreateBucketConfiguration" :: NullOrUndefined.NullOrUndefined (CreateBucketConfiguration) , "GrantFullControl" :: NullOrUndefined.NullOrUndefined (GrantFullControl) , "GrantRead" :: NullOrUndefined.NullOrUndefined (GrantRead) , "GrantReadACP" :: NullOrUndefined.NullOrUndefined (GrantReadACP) , "GrantWrite" :: NullOrUndefined.NullOrUndefined (GrantWrite) , "GrantWriteACP" :: NullOrUndefined.NullOrUndefined (GrantWriteACP) } -> {"ACL" :: NullOrUndefined.NullOrUndefined (BucketCannedACL) , "Bucket" :: (BucketName) , "CreateBucketConfiguration" :: NullOrUndefined.NullOrUndefined (CreateBucketConfiguration) , "GrantFullControl" :: NullOrUndefined.NullOrUndefined (GrantFullControl) , "GrantRead" :: NullOrUndefined.NullOrUndefined (GrantRead) , "GrantReadACP" :: NullOrUndefined.NullOrUndefined (GrantReadACP) , "GrantWrite" :: NullOrUndefined.NullOrUndefined (GrantWrite) , "GrantWriteACP" :: NullOrUndefined.NullOrUndefined (GrantWriteACP) } ) -> CreateBucketRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newCreateMultipartUploadOutput' :: ( { "AbortDate" :: NullOrUndefined.NullOrUndefined (AbortDate) , "AbortRuleId" :: NullOrUndefined.NullOrUndefined (AbortRuleId) , "Bucket" :: NullOrUndefined.NullOrUndefined (BucketName) , "Key" :: NullOrUndefined.NullOrUndefined (ObjectKey) , "UploadId" :: NullOrUndefined.NullOrUndefined (MultipartUploadId) , "ServerSideEncryption" :: NullOrUndefined.NullOrUndefined (ServerSideEncryption) , "SSECustomerAlgorithm" :: NullOrUndefined.NullOrUndefined (SSECustomerAlgorithm) , "SSECustomerKeyMD5" :: NullOrUndefined.NullOrUndefined (SSECustomerKeyMD5) , "SSEKMSKeyId" :: NullOrUndefined.NullOrUndefined (SSEKMSKeyId) , "RequestCharged" :: NullOrUndefined.NullOrUndefined (RequestCharged) } -> {"AbortDate" :: NullOrUndefined.NullOrUndefined (AbortDate) , "AbortRuleId" :: NullOrUndefined.NullOrUndefined (AbortRuleId) , "Bucket" :: NullOrUndefined.NullOrUndefined (BucketName) , "Key" :: NullOrUndefined.NullOrUndefined (ObjectKey) , "UploadId" :: NullOrUndefined.NullOrUndefined (MultipartUploadId) , "ServerSideEncryption" :: NullOrUndefined.NullOrUndefined (ServerSideEncryption) , "SSECustomerAlgorithm" :: NullOrUndefined.NullOrUndefined (SSECustomerAlgorithm) , "SSECustomerKeyMD5" :: NullOrUndefined.NullOrUndefined (SSECustomerKeyMD5) , "SSEKMSKeyId" :: NullOrUndefined.NullOrUndefined (SSEKMSKeyId) , "RequestCharged" :: NullOrUndefined.NullOrUndefined (RequestCharged) } ) -> CreateMultipartUploadOutput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newCreateMultipartUploadRequest' :: BucketName -> ObjectKey -> ( { "ACL" :: NullOrUndefined.NullOrUndefined (ObjectCannedACL) , "Bucket" :: (BucketName) , "CacheControl" :: NullOrUndefined.NullOrUndefined (CacheControl) , "ContentDisposition" :: NullOrUndefined.NullOrUndefined (ContentDisposition) , "ContentEncoding" :: NullOrUndefined.NullOrUndefined (ContentEncoding) , "ContentLanguage" :: NullOrUndefined.NullOrUndefined (ContentLanguage) , "ContentType" :: NullOrUndefined.NullOrUndefined (ContentType) , "Expires" :: NullOrUndefined.NullOrUndefined (Expires) , "GrantFullControl" :: NullOrUndefined.NullOrUndefined (GrantFullControl) , "GrantRead" :: NullOrUndefined.NullOrUndefined (GrantRead) , "GrantReadACP" :: NullOrUndefined.NullOrUndefined (GrantReadACP) , "GrantWriteACP" :: NullOrUndefined.NullOrUndefined (GrantWriteACP) , "Key" :: (ObjectKey) , "Metadata" :: NullOrUndefined.NullOrUndefined (Metadata) , "ServerSideEncryption" :: NullOrUndefined.NullOrUndefined (ServerSideEncryption) , "StorageClass" :: NullOrUndefined.NullOrUndefined (StorageClass) , "WebsiteRedirectLocation" :: NullOrUndefined.NullOrUndefined (WebsiteRedirectLocation) , "SSECustomerAlgorithm" :: NullOrUndefined.NullOrUndefined (SSECustomerAlgorithm) , "SSECustomerKey" :: NullOrUndefined.NullOrUndefined (SSECustomerKey) , "SSECustomerKeyMD5" :: NullOrUndefined.NullOrUndefined (SSECustomerKeyMD5) , "SSEKMSKeyId" :: NullOrUndefined.NullOrUndefined (SSEKMSKeyId) , "RequestPayer" :: NullOrUndefined.NullOrUndefined (RequestPayer) , "Tagging" :: NullOrUndefined.NullOrUndefined (TaggingHeader) } -> {"ACL" :: NullOrUndefined.NullOrUndefined (ObjectCannedACL) , "Bucket" :: (BucketName) , "CacheControl" :: NullOrUndefined.NullOrUndefined (CacheControl) , "ContentDisposition" :: NullOrUndefined.NullOrUndefined (ContentDisposition) , "ContentEncoding" :: NullOrUndefined.NullOrUndefined (ContentEncoding) , "ContentLanguage" :: NullOrUndefined.NullOrUndefined (ContentLanguage) , "ContentType" :: NullOrUndefined.NullOrUndefined (ContentType) , "Expires" :: NullOrUndefined.NullOrUndefined (Expires) , "GrantFullControl" :: NullOrUndefined.NullOrUndefined (GrantFullControl) , "GrantRead" :: NullOrUndefined.NullOrUndefined (GrantRead) , "GrantReadACP" :: NullOrUndefined.NullOrUndefined (GrantReadACP) , "GrantWriteACP" :: NullOrUndefined.NullOrUndefined (GrantWriteACP) , "Key" :: (ObjectKey) , "Metadata" :: NullOrUndefined.NullOrUndefined (Metadata) , "ServerSideEncryption" :: NullOrUndefined.NullOrUndefined (ServerSideEncryption) , "StorageClass" :: NullOrUndefined.NullOrUndefined (StorageClass) , "WebsiteRedirectLocation" :: NullOrUndefined.NullOrUndefined (WebsiteRedirectLocation) , "SSECustomerAlgorithm" :: NullOrUndefined.NullOrUndefined (SSECustomerAlgorithm) , "SSECustomerKey" :: NullOrUndefined.NullOrUndefined (SSECustomerKey) , "SSECustomerKeyMD5" :: NullOrUndefined.NullOrUndefined (SSECustomerKeyMD5) , "SSEKMSKeyId" :: NullOrUndefined.NullOrUndefined (SSEKMSKeyId) , "RequestPayer" :: NullOrUndefined.NullOrUndefined (RequestPayer) , "Tagging" :: NullOrUndefined.NullOrUndefined (TaggingHeader) } ) -> CreateMultipartUploadRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newDelete' :: ObjectIdentifierList -> ( { "Objects" :: (ObjectIdentifierList) , "Quiet" :: NullOrUndefined.NullOrUndefined (Quiet) } -> {"Objects" :: (ObjectIdentifierList) , "Quiet" :: NullOrUndefined.NullOrUndefined (Quiet) } ) -> Delete
...
--   This may be useful if you need to immediately overwrite some of the optional values
newDeleteMarkerEntry' :: ( { "Owner" :: NullOrUndefined.NullOrUndefined (Owner) , "Key" :: NullOrUndefined.NullOrUndefined (ObjectKey) , "VersionId" :: NullOrUndefined.NullOrUndefined (ObjectVersionId) , "IsLatest" :: NullOrUndefined.NullOrUndefined (IsLatest) , "LastModified" :: NullOrUndefined.NullOrUndefined (LastModified) } -> {"Owner" :: NullOrUndefined.NullOrUndefined (Owner) , "Key" :: NullOrUndefined.NullOrUndefined (ObjectKey) , "VersionId" :: NullOrUndefined.NullOrUndefined (ObjectVersionId) , "IsLatest" :: NullOrUndefined.NullOrUndefined (IsLatest) , "LastModified" :: NullOrUndefined.NullOrUndefined (LastModified) } ) -> DeleteMarkerEntry
...
--   This may be useful if you need to immediately overwrite some of the optional values
newDeleteObjectOutput' :: ( { "DeleteMarker" :: NullOrUndefined.NullOrUndefined (DeleteMarker) , "VersionId" :: NullOrUndefined.NullOrUndefined (ObjectVersionId) , "RequestCharged" :: NullOrUndefined.NullOrUndefined (RequestCharged) } -> {"DeleteMarker" :: NullOrUndefined.NullOrUndefined (DeleteMarker) , "VersionId" :: NullOrUndefined.NullOrUndefined (ObjectVersionId) , "RequestCharged" :: NullOrUndefined.NullOrUndefined (RequestCharged) } ) -> DeleteObjectOutput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newDeleteObjectRequest' :: BucketName -> ObjectKey -> ( { "Bucket" :: (BucketName) , "Key" :: (ObjectKey) , "MFA" :: NullOrUndefined.NullOrUndefined (MFA) , "VersionId" :: NullOrUndefined.NullOrUndefined (ObjectVersionId) , "RequestPayer" :: NullOrUndefined.NullOrUndefined (RequestPayer) } -> {"Bucket" :: (BucketName) , "Key" :: (ObjectKey) , "MFA" :: NullOrUndefined.NullOrUndefined (MFA) , "VersionId" :: NullOrUndefined.NullOrUndefined (ObjectVersionId) , "RequestPayer" :: NullOrUndefined.NullOrUndefined (RequestPayer) } ) -> DeleteObjectRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newDeleteObjectTaggingOutput' :: ( { "VersionId" :: NullOrUndefined.NullOrUndefined (ObjectVersionId) } -> {"VersionId" :: NullOrUndefined.NullOrUndefined (ObjectVersionId) } ) -> DeleteObjectTaggingOutput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newDeleteObjectTaggingRequest' :: BucketName -> ObjectKey -> ( { "Bucket" :: (BucketName) , "Key" :: (ObjectKey) , "VersionId" :: NullOrUndefined.NullOrUndefined (ObjectVersionId) } -> {"Bucket" :: (BucketName) , "Key" :: (ObjectKey) , "VersionId" :: NullOrUndefined.NullOrUndefined (ObjectVersionId) } ) -> DeleteObjectTaggingRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newDeleteObjectsOutput' :: ( { "Deleted" :: NullOrUndefined.NullOrUndefined (DeletedObjects) , "RequestCharged" :: NullOrUndefined.NullOrUndefined (RequestCharged) , "Errors" :: NullOrUndefined.NullOrUndefined (Errors) } -> {"Deleted" :: NullOrUndefined.NullOrUndefined (DeletedObjects) , "RequestCharged" :: NullOrUndefined.NullOrUndefined (RequestCharged) , "Errors" :: NullOrUndefined.NullOrUndefined (Errors) } ) -> DeleteObjectsOutput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newDeleteObjectsRequest' :: BucketName -> Delete -> ( { "Bucket" :: (BucketName) , "Delete" :: (Delete) , "MFA" :: NullOrUndefined.NullOrUndefined (MFA) , "RequestPayer" :: NullOrUndefined.NullOrUndefined (RequestPayer) } -> {"Bucket" :: (BucketName) , "Delete" :: (Delete) , "MFA" :: NullOrUndefined.NullOrUndefined (MFA) , "RequestPayer" :: NullOrUndefined.NullOrUndefined (RequestPayer) } ) -> DeleteObjectsRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newDeletedObject' :: ( { "Key" :: NullOrUndefined.NullOrUndefined (ObjectKey) , "VersionId" :: NullOrUndefined.NullOrUndefined (ObjectVersionId) , "DeleteMarker" :: NullOrUndefined.NullOrUndefined (DeleteMarker) , "DeleteMarkerVersionId" :: NullOrUndefined.NullOrUndefined (DeleteMarkerVersionId) } -> {"Key" :: NullOrUndefined.NullOrUndefined (ObjectKey) , "VersionId" :: NullOrUndefined.NullOrUndefined (ObjectVersionId) , "DeleteMarker" :: NullOrUndefined.NullOrUndefined (DeleteMarker) , "DeleteMarkerVersionId" :: NullOrUndefined.NullOrUndefined (DeleteMarkerVersionId) } ) -> DeletedObject
...
--   This may be useful if you need to immediately overwrite some of the optional values
newDestination' :: BucketName -> ( { "Bucket" :: (BucketName) , "Account" :: NullOrUndefined.NullOrUndefined (AccountId) , "StorageClass" :: NullOrUndefined.NullOrUndefined (StorageClass) , "AccessControlTranslation" :: NullOrUndefined.NullOrUndefined (AccessControlTranslation) , "EncryptionConfiguration" :: NullOrUndefined.NullOrUndefined (EncryptionConfiguration) } -> {"Bucket" :: (BucketName) , "Account" :: NullOrUndefined.NullOrUndefined (AccountId) , "StorageClass" :: NullOrUndefined.NullOrUndefined (StorageClass) , "AccessControlTranslation" :: NullOrUndefined.NullOrUndefined (AccessControlTranslation) , "EncryptionConfiguration" :: NullOrUndefined.NullOrUndefined (EncryptionConfiguration) } ) -> Destination
...
--   This may be useful if you need to immediately overwrite some of the optional values
newEncryption' :: ServerSideEncryption -> ( { "EncryptionType" :: (ServerSideEncryption) , "KMSKeyId" :: NullOrUndefined.NullOrUndefined (SSEKMSKeyId) , "KMSContext" :: NullOrUndefined.NullOrUndefined (KMSContext) } -> {"EncryptionType" :: (ServerSideEncryption) , "KMSKeyId" :: NullOrUndefined.NullOrUndefined (SSEKMSKeyId) , "KMSContext" :: NullOrUndefined.NullOrUndefined (KMSContext) } ) -> Encryption
...
--   This may be useful if you need to immediately overwrite some of the optional values
newEncryptionConfiguration' :: ( { "ReplicaKmsKeyID" :: NullOrUndefined.NullOrUndefined (ReplicaKmsKeyID) } -> {"ReplicaKmsKeyID" :: NullOrUndefined.NullOrUndefined (ReplicaKmsKeyID) } ) -> EncryptionConfiguration
...
--   This may be useful if you need to immediately overwrite some of the optional values
newError' :: ( { "Key" :: NullOrUndefined.NullOrUndefined (ObjectKey) , "VersionId" :: NullOrUndefined.NullOrUndefined (ObjectVersionId) , "Code" :: NullOrUndefined.NullOrUndefined (Code) , "Message" :: NullOrUndefined.NullOrUndefined (Message) } -> {"Key" :: NullOrUndefined.NullOrUndefined (ObjectKey) , "VersionId" :: NullOrUndefined.NullOrUndefined (ObjectVersionId) , "Code" :: NullOrUndefined.NullOrUndefined (Code) , "Message" :: NullOrUndefined.NullOrUndefined (Message) } ) -> Error
...
--   This may be useful if you need to immediately overwrite some of the optional values
newFilterRule' :: ( { "Name" :: NullOrUndefined.NullOrUndefined (FilterRuleName) , "Value" :: NullOrUndefined.NullOrUndefined (FilterRuleValue) } -> {"Name" :: NullOrUndefined.NullOrUndefined (FilterRuleName) , "Value" :: NullOrUndefined.NullOrUndefined (FilterRuleValue) } ) -> FilterRule
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetBucketAccelerateConfigurationOutput' :: ( { "Status" :: NullOrUndefined.NullOrUndefined (BucketAccelerateStatus) } -> {"Status" :: NullOrUndefined.NullOrUndefined (BucketAccelerateStatus) } ) -> GetBucketAccelerateConfigurationOutput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetBucketAclOutput' :: ( { "Owner" :: NullOrUndefined.NullOrUndefined (Owner) , "Grants" :: NullOrUndefined.NullOrUndefined (Grants) } -> {"Owner" :: NullOrUndefined.NullOrUndefined (Owner) , "Grants" :: NullOrUndefined.NullOrUndefined (Grants) } ) -> GetBucketAclOutput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetBucketAnalyticsConfigurationOutput' :: ( { "AnalyticsConfiguration" :: NullOrUndefined.NullOrUndefined (AnalyticsConfiguration) } -> {"AnalyticsConfiguration" :: NullOrUndefined.NullOrUndefined (AnalyticsConfiguration) } ) -> GetBucketAnalyticsConfigurationOutput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetBucketCorsOutput' :: ( { "CORSRules" :: NullOrUndefined.NullOrUndefined (CORSRules) } -> {"CORSRules" :: NullOrUndefined.NullOrUndefined (CORSRules) } ) -> GetBucketCorsOutput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetBucketEncryptionOutput' :: ( { "ServerSideEncryptionConfiguration" :: NullOrUndefined.NullOrUndefined (ServerSideEncryptionConfiguration) } -> {"ServerSideEncryptionConfiguration" :: NullOrUndefined.NullOrUndefined (ServerSideEncryptionConfiguration) } ) -> GetBucketEncryptionOutput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetBucketInventoryConfigurationOutput' :: ( { "InventoryConfiguration" :: NullOrUndefined.NullOrUndefined (InventoryConfiguration) } -> {"InventoryConfiguration" :: NullOrUndefined.NullOrUndefined (InventoryConfiguration) } ) -> GetBucketInventoryConfigurationOutput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetBucketLifecycleConfigurationOutput' :: ( { "Rules" :: NullOrUndefined.NullOrUndefined (LifecycleRules) } -> {"Rules" :: NullOrUndefined.NullOrUndefined (LifecycleRules) } ) -> GetBucketLifecycleConfigurationOutput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetBucketLifecycleOutput' :: ( { "Rules" :: NullOrUndefined.NullOrUndefined (Rules) } -> {"Rules" :: NullOrUndefined.NullOrUndefined (Rules) } ) -> GetBucketLifecycleOutput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetBucketLocationOutput' :: ( { "LocationConstraint" :: NullOrUndefined.NullOrUndefined (BucketLocationConstraint) } -> {"LocationConstraint" :: NullOrUndefined.NullOrUndefined (BucketLocationConstraint) } ) -> GetBucketLocationOutput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetBucketLoggingOutput' :: ( { "LoggingEnabled" :: NullOrUndefined.NullOrUndefined (LoggingEnabled) } -> {"LoggingEnabled" :: NullOrUndefined.NullOrUndefined (LoggingEnabled) } ) -> GetBucketLoggingOutput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetBucketMetricsConfigurationOutput' :: ( { "MetricsConfiguration" :: NullOrUndefined.NullOrUndefined (MetricsConfiguration) } -> {"MetricsConfiguration" :: NullOrUndefined.NullOrUndefined (MetricsConfiguration) } ) -> GetBucketMetricsConfigurationOutput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetBucketPolicyOutput' :: ( { "Policy" :: NullOrUndefined.NullOrUndefined (Policy) } -> {"Policy" :: NullOrUndefined.NullOrUndefined (Policy) } ) -> GetBucketPolicyOutput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetBucketReplicationOutput' :: ( { "ReplicationConfiguration" :: NullOrUndefined.NullOrUndefined (ReplicationConfiguration) } -> {"ReplicationConfiguration" :: NullOrUndefined.NullOrUndefined (ReplicationConfiguration) } ) -> GetBucketReplicationOutput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetBucketRequestPaymentOutput' :: ( { "Payer" :: NullOrUndefined.NullOrUndefined (Payer) } -> {"Payer" :: NullOrUndefined.NullOrUndefined (Payer) } ) -> GetBucketRequestPaymentOutput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetBucketVersioningOutput' :: ( { "Status" :: NullOrUndefined.NullOrUndefined (BucketVersioningStatus) , "MFADelete" :: NullOrUndefined.NullOrUndefined (MFADeleteStatus) } -> {"Status" :: NullOrUndefined.NullOrUndefined (BucketVersioningStatus) , "MFADelete" :: NullOrUndefined.NullOrUndefined (MFADeleteStatus) } ) -> GetBucketVersioningOutput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetBucketWebsiteOutput' :: ( { "RedirectAllRequestsTo" :: NullOrUndefined.NullOrUndefined (RedirectAllRequestsTo) , "IndexDocument" :: NullOrUndefined.NullOrUndefined (IndexDocument) , "ErrorDocument" :: NullOrUndefined.NullOrUndefined (ErrorDocument) , "RoutingRules" :: NullOrUndefined.NullOrUndefined (RoutingRules) } -> {"RedirectAllRequestsTo" :: NullOrUndefined.NullOrUndefined (RedirectAllRequestsTo) , "IndexDocument" :: NullOrUndefined.NullOrUndefined (IndexDocument) , "ErrorDocument" :: NullOrUndefined.NullOrUndefined (ErrorDocument) , "RoutingRules" :: NullOrUndefined.NullOrUndefined (RoutingRules) } ) -> GetBucketWebsiteOutput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetObjectAclOutput' :: ( { "Owner" :: NullOrUndefined.NullOrUndefined (Owner) , "Grants" :: NullOrUndefined.NullOrUndefined (Grants) , "RequestCharged" :: NullOrUndefined.NullOrUndefined (RequestCharged) } -> {"Owner" :: NullOrUndefined.NullOrUndefined (Owner) , "Grants" :: NullOrUndefined.NullOrUndefined (Grants) , "RequestCharged" :: NullOrUndefined.NullOrUndefined (RequestCharged) } ) -> GetObjectAclOutput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetObjectOutput' :: ( { "Body" :: NullOrUndefined.NullOrUndefined (Body) , "DeleteMarker" :: NullOrUndefined.NullOrUndefined (DeleteMarker) , "AcceptRanges" :: NullOrUndefined.NullOrUndefined (AcceptRanges) , "Expiration" :: NullOrUndefined.NullOrUndefined (Expiration) , "Restore" :: NullOrUndefined.NullOrUndefined (Restore) , "LastModified" :: NullOrUndefined.NullOrUndefined (LastModified) , "ContentLength" :: NullOrUndefined.NullOrUndefined (ContentLength) , "ETag" :: NullOrUndefined.NullOrUndefined (ETag) , "MissingMeta" :: NullOrUndefined.NullOrUndefined (MissingMeta) , "VersionId" :: NullOrUndefined.NullOrUndefined (ObjectVersionId) , "CacheControl" :: NullOrUndefined.NullOrUndefined (CacheControl) , "ContentDisposition" :: NullOrUndefined.NullOrUndefined (ContentDisposition) , "ContentEncoding" :: NullOrUndefined.NullOrUndefined (ContentEncoding) , "ContentLanguage" :: NullOrUndefined.NullOrUndefined (ContentLanguage) , "ContentRange" :: NullOrUndefined.NullOrUndefined (ContentRange) , "ContentType" :: NullOrUndefined.NullOrUndefined (ContentType) , "Expires" :: NullOrUndefined.NullOrUndefined (Expires) , "WebsiteRedirectLocation" :: NullOrUndefined.NullOrUndefined (WebsiteRedirectLocation) , "ServerSideEncryption" :: NullOrUndefined.NullOrUndefined (ServerSideEncryption) , "Metadata" :: NullOrUndefined.NullOrUndefined (Metadata) , "SSECustomerAlgorithm" :: NullOrUndefined.NullOrUndefined (SSECustomerAlgorithm) , "SSECustomerKeyMD5" :: NullOrUndefined.NullOrUndefined (SSECustomerKeyMD5) , "SSEKMSKeyId" :: NullOrUndefined.NullOrUndefined (SSEKMSKeyId) , "StorageClass" :: NullOrUndefined.NullOrUndefined (StorageClass) , "RequestCharged" :: NullOrUndefined.NullOrUndefined (RequestCharged) , "ReplicationStatus" :: NullOrUndefined.NullOrUndefined (ReplicationStatus) , "PartsCount" :: NullOrUndefined.NullOrUndefined (PartsCount) , "TagCount" :: NullOrUndefined.NullOrUndefined (TagCount) } -> {"Body" :: NullOrUndefined.NullOrUndefined (Body) , "DeleteMarker" :: NullOrUndefined.NullOrUndefined (DeleteMarker) , "AcceptRanges" :: NullOrUndefined.NullOrUndefined (AcceptRanges) , "Expiration" :: NullOrUndefined.NullOrUndefined (Expiration) , "Restore" :: NullOrUndefined.NullOrUndefined (Restore) , "LastModified" :: NullOrUndefined.NullOrUndefined (LastModified) , "ContentLength" :: NullOrUndefined.NullOrUndefined (ContentLength) , "ETag" :: NullOrUndefined.NullOrUndefined (ETag) , "MissingMeta" :: NullOrUndefined.NullOrUndefined (MissingMeta) , "VersionId" :: NullOrUndefined.NullOrUndefined (ObjectVersionId) , "CacheControl" :: NullOrUndefined.NullOrUndefined (CacheControl) , "ContentDisposition" :: NullOrUndefined.NullOrUndefined (ContentDisposition) , "ContentEncoding" :: NullOrUndefined.NullOrUndefined (ContentEncoding) , "ContentLanguage" :: NullOrUndefined.NullOrUndefined (ContentLanguage) , "ContentRange" :: NullOrUndefined.NullOrUndefined (ContentRange) , "ContentType" :: NullOrUndefined.NullOrUndefined (ContentType) , "Expires" :: NullOrUndefined.NullOrUndefined (Expires) , "WebsiteRedirectLocation" :: NullOrUndefined.NullOrUndefined (WebsiteRedirectLocation) , "ServerSideEncryption" :: NullOrUndefined.NullOrUndefined (ServerSideEncryption) , "Metadata" :: NullOrUndefined.NullOrUndefined (Metadata) , "SSECustomerAlgorithm" :: NullOrUndefined.NullOrUndefined (SSECustomerAlgorithm) , "SSECustomerKeyMD5" :: NullOrUndefined.NullOrUndefined (SSECustomerKeyMD5) , "SSEKMSKeyId" :: NullOrUndefined.NullOrUndefined (SSEKMSKeyId) , "StorageClass" :: NullOrUndefined.NullOrUndefined (StorageClass) , "RequestCharged" :: NullOrUndefined.NullOrUndefined (RequestCharged) , "ReplicationStatus" :: NullOrUndefined.NullOrUndefined (ReplicationStatus) , "PartsCount" :: NullOrUndefined.NullOrUndefined (PartsCount) , "TagCount" :: NullOrUndefined.NullOrUndefined (TagCount) } ) -> GetObjectOutput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetObjectRequest' :: BucketName -> ObjectKey -> ( { "Bucket" :: (BucketName) , "IfMatch" :: NullOrUndefined.NullOrUndefined (IfMatch) , "IfModifiedSince" :: NullOrUndefined.NullOrUndefined (IfModifiedSince) , "IfNoneMatch" :: NullOrUndefined.NullOrUndefined (IfNoneMatch) , "IfUnmodifiedSince" :: NullOrUndefined.NullOrUndefined (IfUnmodifiedSince) , "Key" :: (ObjectKey) , "Range" :: NullOrUndefined.NullOrUndefined (Range) , "ResponseCacheControl" :: NullOrUndefined.NullOrUndefined (ResponseCacheControl) , "ResponseContentDisposition" :: NullOrUndefined.NullOrUndefined (ResponseContentDisposition) , "ResponseContentEncoding" :: NullOrUndefined.NullOrUndefined (ResponseContentEncoding) , "ResponseContentLanguage" :: NullOrUndefined.NullOrUndefined (ResponseContentLanguage) , "ResponseContentType" :: NullOrUndefined.NullOrUndefined (ResponseContentType) , "ResponseExpires" :: NullOrUndefined.NullOrUndefined (ResponseExpires) , "VersionId" :: NullOrUndefined.NullOrUndefined (ObjectVersionId) , "SSECustomerAlgorithm" :: NullOrUndefined.NullOrUndefined (SSECustomerAlgorithm) , "SSECustomerKey" :: NullOrUndefined.NullOrUndefined (SSECustomerKey) , "SSECustomerKeyMD5" :: NullOrUndefined.NullOrUndefined (SSECustomerKeyMD5) , "RequestPayer" :: NullOrUndefined.NullOrUndefined (RequestPayer) , "PartNumber" :: NullOrUndefined.NullOrUndefined (PartNumber) } -> {"Bucket" :: (BucketName) , "IfMatch" :: NullOrUndefined.NullOrUndefined (IfMatch) , "IfModifiedSince" :: NullOrUndefined.NullOrUndefined (IfModifiedSince) , "IfNoneMatch" :: NullOrUndefined.NullOrUndefined (IfNoneMatch) , "IfUnmodifiedSince" :: NullOrUndefined.NullOrUndefined (IfUnmodifiedSince) , "Key" :: (ObjectKey) , "Range" :: NullOrUndefined.NullOrUndefined (Range) , "ResponseCacheControl" :: NullOrUndefined.NullOrUndefined (ResponseCacheControl) , "ResponseContentDisposition" :: NullOrUndefined.NullOrUndefined (ResponseContentDisposition) , "ResponseContentEncoding" :: NullOrUndefined.NullOrUndefined (ResponseContentEncoding) , "ResponseContentLanguage" :: NullOrUndefined.NullOrUndefined (ResponseContentLanguage) , "ResponseContentType" :: NullOrUndefined.NullOrUndefined (ResponseContentType) , "ResponseExpires" :: NullOrUndefined.NullOrUndefined (ResponseExpires) , "VersionId" :: NullOrUndefined.NullOrUndefined (ObjectVersionId) , "SSECustomerAlgorithm" :: NullOrUndefined.NullOrUndefined (SSECustomerAlgorithm) , "SSECustomerKey" :: NullOrUndefined.NullOrUndefined (SSECustomerKey) , "SSECustomerKeyMD5" :: NullOrUndefined.NullOrUndefined (SSECustomerKeyMD5) , "RequestPayer" :: NullOrUndefined.NullOrUndefined (RequestPayer) , "PartNumber" :: NullOrUndefined.NullOrUndefined (PartNumber) } ) -> GetObjectRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetObjectTaggingOutput' :: TagSet -> ( { "VersionId" :: NullOrUndefined.NullOrUndefined (ObjectVersionId) , "TagSet" :: (TagSet) } -> {"VersionId" :: NullOrUndefined.NullOrUndefined (ObjectVersionId) , "TagSet" :: (TagSet) } ) -> GetObjectTaggingOutput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetObjectTaggingRequest' :: BucketName -> ObjectKey -> ( { "Bucket" :: (BucketName) , "Key" :: (ObjectKey) , "VersionId" :: NullOrUndefined.NullOrUndefined (ObjectVersionId) } -> {"Bucket" :: (BucketName) , "Key" :: (ObjectKey) , "VersionId" :: NullOrUndefined.NullOrUndefined (ObjectVersionId) } ) -> GetObjectTaggingRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetObjectTorrentOutput' :: ( { "Body" :: NullOrUndefined.NullOrUndefined (Body) , "RequestCharged" :: NullOrUndefined.NullOrUndefined (RequestCharged) } -> {"Body" :: NullOrUndefined.NullOrUndefined (Body) , "RequestCharged" :: NullOrUndefined.NullOrUndefined (RequestCharged) } ) -> GetObjectTorrentOutput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetObjectTorrentRequest' :: BucketName -> ObjectKey -> ( { "Bucket" :: (BucketName) , "Key" :: (ObjectKey) , "RequestPayer" :: NullOrUndefined.NullOrUndefined (RequestPayer) } -> {"Bucket" :: (BucketName) , "Key" :: (ObjectKey) , "RequestPayer" :: NullOrUndefined.NullOrUndefined (RequestPayer) } ) -> GetObjectTorrentRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGrantee' :: Type -> ( { "DisplayName" :: NullOrUndefined.NullOrUndefined (DisplayName) , "EmailAddress" :: NullOrUndefined.NullOrUndefined (EmailAddress) , "ID" :: NullOrUndefined.NullOrUndefined (ID) , "Type" :: (Type) , "URI" :: NullOrUndefined.NullOrUndefined (URI) } -> {"DisplayName" :: NullOrUndefined.NullOrUndefined (DisplayName) , "EmailAddress" :: NullOrUndefined.NullOrUndefined (EmailAddress) , "ID" :: NullOrUndefined.NullOrUndefined (ID) , "Type" :: (Type) , "URI" :: NullOrUndefined.NullOrUndefined (URI) } ) -> Grantee
...
--   This may be useful if you need to immediately overwrite some of the optional values
newHeadObjectOutput' :: ( { "DeleteMarker" :: NullOrUndefined.NullOrUndefined (DeleteMarker) , "AcceptRanges" :: NullOrUndefined.NullOrUndefined (AcceptRanges) , "Expiration" :: NullOrUndefined.NullOrUndefined (Expiration) , "Restore" :: NullOrUndefined.NullOrUndefined (Restore) , "LastModified" :: NullOrUndefined.NullOrUndefined (LastModified) , "ContentLength" :: NullOrUndefined.NullOrUndefined (ContentLength) , "ETag" :: NullOrUndefined.NullOrUndefined (ETag) , "MissingMeta" :: NullOrUndefined.NullOrUndefined (MissingMeta) , "VersionId" :: NullOrUndefined.NullOrUndefined (ObjectVersionId) , "CacheControl" :: NullOrUndefined.NullOrUndefined (CacheControl) , "ContentDisposition" :: NullOrUndefined.NullOrUndefined (ContentDisposition) , "ContentEncoding" :: NullOrUndefined.NullOrUndefined (ContentEncoding) , "ContentLanguage" :: NullOrUndefined.NullOrUndefined (ContentLanguage) , "ContentType" :: NullOrUndefined.NullOrUndefined (ContentType) , "Expires" :: NullOrUndefined.NullOrUndefined (Expires) , "WebsiteRedirectLocation" :: NullOrUndefined.NullOrUndefined (WebsiteRedirectLocation) , "ServerSideEncryption" :: NullOrUndefined.NullOrUndefined (ServerSideEncryption) , "Metadata" :: NullOrUndefined.NullOrUndefined (Metadata) , "SSECustomerAlgorithm" :: NullOrUndefined.NullOrUndefined (SSECustomerAlgorithm) , "SSECustomerKeyMD5" :: NullOrUndefined.NullOrUndefined (SSECustomerKeyMD5) , "SSEKMSKeyId" :: NullOrUndefined.NullOrUndefined (SSEKMSKeyId) , "StorageClass" :: NullOrUndefined.NullOrUndefined (StorageClass) , "RequestCharged" :: NullOrUndefined.NullOrUndefined (RequestCharged) , "ReplicationStatus" :: NullOrUndefined.NullOrUndefined (ReplicationStatus) , "PartsCount" :: NullOrUndefined.NullOrUndefined (PartsCount) } -> {"DeleteMarker" :: NullOrUndefined.NullOrUndefined (DeleteMarker) , "AcceptRanges" :: NullOrUndefined.NullOrUndefined (AcceptRanges) , "Expiration" :: NullOrUndefined.NullOrUndefined (Expiration) , "Restore" :: NullOrUndefined.NullOrUndefined (Restore) , "LastModified" :: NullOrUndefined.NullOrUndefined (LastModified) , "ContentLength" :: NullOrUndefined.NullOrUndefined (ContentLength) , "ETag" :: NullOrUndefined.NullOrUndefined (ETag) , "MissingMeta" :: NullOrUndefined.NullOrUndefined (MissingMeta) , "VersionId" :: NullOrUndefined.NullOrUndefined (ObjectVersionId) , "CacheControl" :: NullOrUndefined.NullOrUndefined (CacheControl) , "ContentDisposition" :: NullOrUndefined.NullOrUndefined (ContentDisposition) , "ContentEncoding" :: NullOrUndefined.NullOrUndefined (ContentEncoding) , "ContentLanguage" :: NullOrUndefined.NullOrUndefined (ContentLanguage) , "ContentType" :: NullOrUndefined.NullOrUndefined (ContentType) , "Expires" :: NullOrUndefined.NullOrUndefined (Expires) , "WebsiteRedirectLocation" :: NullOrUndefined.NullOrUndefined (WebsiteRedirectLocation) , "ServerSideEncryption" :: NullOrUndefined.NullOrUndefined (ServerSideEncryption) , "Metadata" :: NullOrUndefined.NullOrUndefined (Metadata) , "SSECustomerAlgorithm" :: NullOrUndefined.NullOrUndefined (SSECustomerAlgorithm) , "SSECustomerKeyMD5" :: NullOrUndefined.NullOrUndefined (SSECustomerKeyMD5) , "SSEKMSKeyId" :: NullOrUndefined.NullOrUndefined (SSEKMSKeyId) , "StorageClass" :: NullOrUndefined.NullOrUndefined (StorageClass) , "RequestCharged" :: NullOrUndefined.NullOrUndefined (RequestCharged) , "ReplicationStatus" :: NullOrUndefined.NullOrUndefined (ReplicationStatus) , "PartsCount" :: NullOrUndefined.NullOrUndefined (PartsCount) } ) -> HeadObjectOutput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newHeadObjectRequest' :: BucketName -> ObjectKey -> ( { "Bucket" :: (BucketName) , "IfMatch" :: NullOrUndefined.NullOrUndefined (IfMatch) , "IfModifiedSince" :: NullOrUndefined.NullOrUndefined (IfModifiedSince) , "IfNoneMatch" :: NullOrUndefined.NullOrUndefined (IfNoneMatch) , "IfUnmodifiedSince" :: NullOrUndefined.NullOrUndefined (IfUnmodifiedSince) , "Key" :: (ObjectKey) , "Range" :: NullOrUndefined.NullOrUndefined (Range) , "VersionId" :: NullOrUndefined.NullOrUndefined (ObjectVersionId) , "SSECustomerAlgorithm" :: NullOrUndefined.NullOrUndefined (SSECustomerAlgorithm) , "SSECustomerKey" :: NullOrUndefined.NullOrUndefined (SSECustomerKey) , "SSECustomerKeyMD5" :: NullOrUndefined.NullOrUndefined (SSECustomerKeyMD5) , "RequestPayer" :: NullOrUndefined.NullOrUndefined (RequestPayer) , "PartNumber" :: NullOrUndefined.NullOrUndefined (PartNumber) } -> {"Bucket" :: (BucketName) , "IfMatch" :: NullOrUndefined.NullOrUndefined (IfMatch) , "IfModifiedSince" :: NullOrUndefined.NullOrUndefined (IfModifiedSince) , "IfNoneMatch" :: NullOrUndefined.NullOrUndefined (IfNoneMatch) , "IfUnmodifiedSince" :: NullOrUndefined.NullOrUndefined (IfUnmodifiedSince) , "Key" :: (ObjectKey) , "Range" :: NullOrUndefined.NullOrUndefined (Range) , "VersionId" :: NullOrUndefined.NullOrUndefined (ObjectVersionId) , "SSECustomerAlgorithm" :: NullOrUndefined.NullOrUndefined (SSECustomerAlgorithm) , "SSECustomerKey" :: NullOrUndefined.NullOrUndefined (SSECustomerKey) , "SSECustomerKeyMD5" :: NullOrUndefined.NullOrUndefined (SSECustomerKeyMD5) , "RequestPayer" :: NullOrUndefined.NullOrUndefined (RequestPayer) , "PartNumber" :: NullOrUndefined.NullOrUndefined (PartNumber) } ) -> HeadObjectRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newInitiator' :: ( { "ID" :: NullOrUndefined.NullOrUndefined (ID) , "DisplayName" :: NullOrUndefined.NullOrUndefined (DisplayName) } -> {"ID" :: NullOrUndefined.NullOrUndefined (ID) , "DisplayName" :: NullOrUndefined.NullOrUndefined (DisplayName) } ) -> Initiator
...
--   This may be useful if you need to immediately overwrite some of the optional values
newInventoryConfiguration' :: InventoryDestination -> InventoryId -> InventoryIncludedObjectVersions -> IsEnabled -> InventorySchedule -> ( { "Destination" :: (InventoryDestination) , "IsEnabled" :: (IsEnabled) , "Filter" :: NullOrUndefined.NullOrUndefined (InventoryFilter) , "Id" :: (InventoryId) , "IncludedObjectVersions" :: (InventoryIncludedObjectVersions) , "OptionalFields" :: NullOrUndefined.NullOrUndefined (InventoryOptionalFields) , "Schedule" :: (InventorySchedule) } -> {"Destination" :: (InventoryDestination) , "IsEnabled" :: (IsEnabled) , "Filter" :: NullOrUndefined.NullOrUndefined (InventoryFilter) , "Id" :: (InventoryId) , "IncludedObjectVersions" :: (InventoryIncludedObjectVersions) , "OptionalFields" :: NullOrUndefined.NullOrUndefined (InventoryOptionalFields) , "Schedule" :: (InventorySchedule) } ) -> InventoryConfiguration
...
--   This may be useful if you need to immediately overwrite some of the optional values
newInventoryEncryption' :: ( { "SSES3" :: NullOrUndefined.NullOrUndefined (SSES3) , "SSEKMS" :: NullOrUndefined.NullOrUndefined (SSEKMS) } -> {"SSES3" :: NullOrUndefined.NullOrUndefined (SSES3) , "SSEKMS" :: NullOrUndefined.NullOrUndefined (SSEKMS) } ) -> InventoryEncryption
...
--   This may be useful if you need to immediately overwrite some of the optional values
newInventoryS3BucketDestination' :: BucketName -> InventoryFormat -> ( { "AccountId" :: NullOrUndefined.NullOrUndefined (AccountId) , "Bucket" :: (BucketName) , "Format" :: (InventoryFormat) , "Prefix" :: NullOrUndefined.NullOrUndefined (Prefix) , "Encryption" :: NullOrUndefined.NullOrUndefined (InventoryEncryption) } -> {"AccountId" :: NullOrUndefined.NullOrUndefined (AccountId) , "Bucket" :: (BucketName) , "Format" :: (InventoryFormat) , "Prefix" :: NullOrUndefined.NullOrUndefined (Prefix) , "Encryption" :: NullOrUndefined.NullOrUndefined (InventoryEncryption) } ) -> InventoryS3BucketDestination
...
--   This may be useful if you need to immediately overwrite some of the optional values
newLambdaFunctionConfiguration' :: EventList -> LambdaFunctionArn -> ( { "Id" :: NullOrUndefined.NullOrUndefined (NotificationId) , "LambdaFunctionArn" :: (LambdaFunctionArn) , "Events" :: (EventList) , "Filter" :: NullOrUndefined.NullOrUndefined (NotificationConfigurationFilter) } -> {"Id" :: NullOrUndefined.NullOrUndefined (NotificationId) , "LambdaFunctionArn" :: (LambdaFunctionArn) , "Events" :: (EventList) , "Filter" :: NullOrUndefined.NullOrUndefined (NotificationConfigurationFilter) } ) -> LambdaFunctionConfiguration
...
--   This may be useful if you need to immediately overwrite some of the optional values
newLifecycleExpiration' :: ( { "Date" :: NullOrUndefined.NullOrUndefined (Date) , "Days" :: NullOrUndefined.NullOrUndefined (Days) , "ExpiredObjectDeleteMarker" :: NullOrUndefined.NullOrUndefined (ExpiredObjectDeleteMarker) } -> {"Date" :: NullOrUndefined.NullOrUndefined (Date) , "Days" :: NullOrUndefined.NullOrUndefined (Days) , "ExpiredObjectDeleteMarker" :: NullOrUndefined.NullOrUndefined (ExpiredObjectDeleteMarker) } ) -> LifecycleExpiration
...
--   This may be useful if you need to immediately overwrite some of the optional values
newLifecycleRule' :: ExpirationStatus -> ( { "Expiration" :: NullOrUndefined.NullOrUndefined (LifecycleExpiration) , "ID" :: NullOrUndefined.NullOrUndefined (ID) , "Prefix" :: NullOrUndefined.NullOrUndefined (Prefix) , "Filter" :: NullOrUndefined.NullOrUndefined (LifecycleRuleFilter) , "Status" :: (ExpirationStatus) , "Transitions" :: NullOrUndefined.NullOrUndefined (TransitionList) , "NoncurrentVersionTransitions" :: NullOrUndefined.NullOrUndefined (NoncurrentVersionTransitionList) , "NoncurrentVersionExpiration" :: NullOrUndefined.NullOrUndefined (NoncurrentVersionExpiration) , "AbortIncompleteMultipartUpload" :: NullOrUndefined.NullOrUndefined (AbortIncompleteMultipartUpload) } -> {"Expiration" :: NullOrUndefined.NullOrUndefined (LifecycleExpiration) , "ID" :: NullOrUndefined.NullOrUndefined (ID) , "Prefix" :: NullOrUndefined.NullOrUndefined (Prefix) , "Filter" :: NullOrUndefined.NullOrUndefined (LifecycleRuleFilter) , "Status" :: (ExpirationStatus) , "Transitions" :: NullOrUndefined.NullOrUndefined (TransitionList) , "NoncurrentVersionTransitions" :: NullOrUndefined.NullOrUndefined (NoncurrentVersionTransitionList) , "NoncurrentVersionExpiration" :: NullOrUndefined.NullOrUndefined (NoncurrentVersionExpiration) , "AbortIncompleteMultipartUpload" :: NullOrUndefined.NullOrUndefined (AbortIncompleteMultipartUpload) } ) -> LifecycleRule
...
--   This may be useful if you need to immediately overwrite some of the optional values
newLifecycleRuleAndOperator' :: ( { "Prefix" :: NullOrUndefined.NullOrUndefined (Prefix) , "Tags" :: NullOrUndefined.NullOrUndefined (TagSet) } -> {"Prefix" :: NullOrUndefined.NullOrUndefined (Prefix) , "Tags" :: NullOrUndefined.NullOrUndefined (TagSet) } ) -> LifecycleRuleAndOperator
...
--   This may be useful if you need to immediately overwrite some of the optional values
newLifecycleRuleFilter' :: ( { "Prefix" :: NullOrUndefined.NullOrUndefined (Prefix) , "Tag" :: NullOrUndefined.NullOrUndefined (Tag) , "And" :: NullOrUndefined.NullOrUndefined (LifecycleRuleAndOperator) } -> {"Prefix" :: NullOrUndefined.NullOrUndefined (Prefix) , "Tag" :: NullOrUndefined.NullOrUndefined (Tag) , "And" :: NullOrUndefined.NullOrUndefined (LifecycleRuleAndOperator) } ) -> LifecycleRuleFilter
...
--   This may be useful if you need to immediately overwrite some of the optional values
newListBucketAnalyticsConfigurationsOutput' :: ( { "IsTruncated" :: NullOrUndefined.NullOrUndefined (IsTruncated) , "ContinuationToken" :: NullOrUndefined.NullOrUndefined (Token) , "NextContinuationToken" :: NullOrUndefined.NullOrUndefined (NextToken) , "AnalyticsConfigurationList" :: NullOrUndefined.NullOrUndefined (AnalyticsConfigurationList) } -> {"IsTruncated" :: NullOrUndefined.NullOrUndefined (IsTruncated) , "ContinuationToken" :: NullOrUndefined.NullOrUndefined (Token) , "NextContinuationToken" :: NullOrUndefined.NullOrUndefined (NextToken) , "AnalyticsConfigurationList" :: NullOrUndefined.NullOrUndefined (AnalyticsConfigurationList) } ) -> ListBucketAnalyticsConfigurationsOutput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newListBucketAnalyticsConfigurationsRequest' :: BucketName -> ( { "Bucket" :: (BucketName) , "ContinuationToken" :: NullOrUndefined.NullOrUndefined (Token) } -> {"Bucket" :: (BucketName) , "ContinuationToken" :: NullOrUndefined.NullOrUndefined (Token) } ) -> ListBucketAnalyticsConfigurationsRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newListBucketInventoryConfigurationsOutput' :: ( { "ContinuationToken" :: NullOrUndefined.NullOrUndefined (Token) , "InventoryConfigurationList" :: NullOrUndefined.NullOrUndefined (InventoryConfigurationList) , "IsTruncated" :: NullOrUndefined.NullOrUndefined (IsTruncated) , "NextContinuationToken" :: NullOrUndefined.NullOrUndefined (NextToken) } -> {"ContinuationToken" :: NullOrUndefined.NullOrUndefined (Token) , "InventoryConfigurationList" :: NullOrUndefined.NullOrUndefined (InventoryConfigurationList) , "IsTruncated" :: NullOrUndefined.NullOrUndefined (IsTruncated) , "NextContinuationToken" :: NullOrUndefined.NullOrUndefined (NextToken) } ) -> ListBucketInventoryConfigurationsOutput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newListBucketInventoryConfigurationsRequest' :: BucketName -> ( { "Bucket" :: (BucketName) , "ContinuationToken" :: NullOrUndefined.NullOrUndefined (Token) } -> {"Bucket" :: (BucketName) , "ContinuationToken" :: NullOrUndefined.NullOrUndefined (Token) } ) -> ListBucketInventoryConfigurationsRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newListBucketMetricsConfigurationsOutput' :: ( { "IsTruncated" :: NullOrUndefined.NullOrUndefined (IsTruncated) , "ContinuationToken" :: NullOrUndefined.NullOrUndefined (Token) , "NextContinuationToken" :: NullOrUndefined.NullOrUndefined (NextToken) , "MetricsConfigurationList" :: NullOrUndefined.NullOrUndefined (MetricsConfigurationList) } -> {"IsTruncated" :: NullOrUndefined.NullOrUndefined (IsTruncated) , "ContinuationToken" :: NullOrUndefined.NullOrUndefined (Token) , "NextContinuationToken" :: NullOrUndefined.NullOrUndefined (NextToken) , "MetricsConfigurationList" :: NullOrUndefined.NullOrUndefined (MetricsConfigurationList) } ) -> ListBucketMetricsConfigurationsOutput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newListBucketMetricsConfigurationsRequest' :: BucketName -> ( { "Bucket" :: (BucketName) , "ContinuationToken" :: NullOrUndefined.NullOrUndefined (Token) } -> {"Bucket" :: (BucketName) , "ContinuationToken" :: NullOrUndefined.NullOrUndefined (Token) } ) -> ListBucketMetricsConfigurationsRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newListBucketsOutput' :: ( { "Buckets" :: NullOrUndefined.NullOrUndefined (Buckets) , "Owner" :: NullOrUndefined.NullOrUndefined (Owner) } -> {"Buckets" :: NullOrUndefined.NullOrUndefined (Buckets) , "Owner" :: NullOrUndefined.NullOrUndefined (Owner) } ) -> ListBucketsOutput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newListMultipartUploadsOutput' :: ( { "Bucket" :: NullOrUndefined.NullOrUndefined (BucketName) , "KeyMarker" :: NullOrUndefined.NullOrUndefined (KeyMarker) , "UploadIdMarker" :: NullOrUndefined.NullOrUndefined (UploadIdMarker) , "NextKeyMarker" :: NullOrUndefined.NullOrUndefined (NextKeyMarker) , "Prefix" :: NullOrUndefined.NullOrUndefined (Prefix) , "Delimiter" :: NullOrUndefined.NullOrUndefined (Delimiter) , "NextUploadIdMarker" :: NullOrUndefined.NullOrUndefined (NextUploadIdMarker) , "MaxUploads" :: NullOrUndefined.NullOrUndefined (MaxUploads) , "IsTruncated" :: NullOrUndefined.NullOrUndefined (IsTruncated) , "Uploads" :: NullOrUndefined.NullOrUndefined (MultipartUploadList) , "CommonPrefixes" :: NullOrUndefined.NullOrUndefined (CommonPrefixList) , "EncodingType" :: NullOrUndefined.NullOrUndefined (EncodingType) } -> {"Bucket" :: NullOrUndefined.NullOrUndefined (BucketName) , "KeyMarker" :: NullOrUndefined.NullOrUndefined (KeyMarker) , "UploadIdMarker" :: NullOrUndefined.NullOrUndefined (UploadIdMarker) , "NextKeyMarker" :: NullOrUndefined.NullOrUndefined (NextKeyMarker) , "Prefix" :: NullOrUndefined.NullOrUndefined (Prefix) , "Delimiter" :: NullOrUndefined.NullOrUndefined (Delimiter) , "NextUploadIdMarker" :: NullOrUndefined.NullOrUndefined (NextUploadIdMarker) , "MaxUploads" :: NullOrUndefined.NullOrUndefined (MaxUploads) , "IsTruncated" :: NullOrUndefined.NullOrUndefined (IsTruncated) , "Uploads" :: NullOrUndefined.NullOrUndefined (MultipartUploadList) , "CommonPrefixes" :: NullOrUndefined.NullOrUndefined (CommonPrefixList) , "EncodingType" :: NullOrUndefined.NullOrUndefined (EncodingType) } ) -> ListMultipartUploadsOutput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newListMultipartUploadsRequest' :: BucketName -> ( { "Bucket" :: (BucketName) , "Delimiter" :: NullOrUndefined.NullOrUndefined (Delimiter) , "EncodingType" :: NullOrUndefined.NullOrUndefined (EncodingType) , "KeyMarker" :: NullOrUndefined.NullOrUndefined (KeyMarker) , "MaxUploads" :: NullOrUndefined.NullOrUndefined (MaxUploads) , "Prefix" :: NullOrUndefined.NullOrUndefined (Prefix) , "UploadIdMarker" :: NullOrUndefined.NullOrUndefined (UploadIdMarker) } -> {"Bucket" :: (BucketName) , "Delimiter" :: NullOrUndefined.NullOrUndefined (Delimiter) , "EncodingType" :: NullOrUndefined.NullOrUndefined (EncodingType) , "KeyMarker" :: NullOrUndefined.NullOrUndefined (KeyMarker) , "MaxUploads" :: NullOrUndefined.NullOrUndefined (MaxUploads) , "Prefix" :: NullOrUndefined.NullOrUndefined (Prefix) , "UploadIdMarker" :: NullOrUndefined.NullOrUndefined (UploadIdMarker) } ) -> ListMultipartUploadsRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newListObjectVersionsOutput' :: ( { "IsTruncated" :: NullOrUndefined.NullOrUndefined (IsTruncated) , "KeyMarker" :: NullOrUndefined.NullOrUndefined (KeyMarker) , "VersionIdMarker" :: NullOrUndefined.NullOrUndefined (VersionIdMarker) , "NextKeyMarker" :: NullOrUndefined.NullOrUndefined (NextKeyMarker) , "NextVersionIdMarker" :: NullOrUndefined.NullOrUndefined (NextVersionIdMarker) , "Versions" :: NullOrUndefined.NullOrUndefined (ObjectVersionList) , "DeleteMarkers" :: NullOrUndefined.NullOrUndefined (DeleteMarkers) , "Name" :: NullOrUndefined.NullOrUndefined (BucketName) , "Prefix" :: NullOrUndefined.NullOrUndefined (Prefix) , "Delimiter" :: NullOrUndefined.NullOrUndefined (Delimiter) , "MaxKeys" :: NullOrUndefined.NullOrUndefined (MaxKeys) , "CommonPrefixes" :: NullOrUndefined.NullOrUndefined (CommonPrefixList) , "EncodingType" :: NullOrUndefined.NullOrUndefined (EncodingType) } -> {"IsTruncated" :: NullOrUndefined.NullOrUndefined (IsTruncated) , "KeyMarker" :: NullOrUndefined.NullOrUndefined (KeyMarker) , "VersionIdMarker" :: NullOrUndefined.NullOrUndefined (VersionIdMarker) , "NextKeyMarker" :: NullOrUndefined.NullOrUndefined (NextKeyMarker) , "NextVersionIdMarker" :: NullOrUndefined.NullOrUndefined (NextVersionIdMarker) , "Versions" :: NullOrUndefined.NullOrUndefined (ObjectVersionList) , "DeleteMarkers" :: NullOrUndefined.NullOrUndefined (DeleteMarkers) , "Name" :: NullOrUndefined.NullOrUndefined (BucketName) , "Prefix" :: NullOrUndefined.NullOrUndefined (Prefix) , "Delimiter" :: NullOrUndefined.NullOrUndefined (Delimiter) , "MaxKeys" :: NullOrUndefined.NullOrUndefined (MaxKeys) , "CommonPrefixes" :: NullOrUndefined.NullOrUndefined (CommonPrefixList) , "EncodingType" :: NullOrUndefined.NullOrUndefined (EncodingType) } ) -> ListObjectVersionsOutput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newListObjectVersionsRequest' :: BucketName -> ( { "Bucket" :: (BucketName) , "Delimiter" :: NullOrUndefined.NullOrUndefined (Delimiter) , "EncodingType" :: NullOrUndefined.NullOrUndefined (EncodingType) , "KeyMarker" :: NullOrUndefined.NullOrUndefined (KeyMarker) , "MaxKeys" :: NullOrUndefined.NullOrUndefined (MaxKeys) , "Prefix" :: NullOrUndefined.NullOrUndefined (Prefix) , "VersionIdMarker" :: NullOrUndefined.NullOrUndefined (VersionIdMarker) } -> {"Bucket" :: (BucketName) , "Delimiter" :: NullOrUndefined.NullOrUndefined (Delimiter) , "EncodingType" :: NullOrUndefined.NullOrUndefined (EncodingType) , "KeyMarker" :: NullOrUndefined.NullOrUndefined (KeyMarker) , "MaxKeys" :: NullOrUndefined.NullOrUndefined (MaxKeys) , "Prefix" :: NullOrUndefined.NullOrUndefined (Prefix) , "VersionIdMarker" :: NullOrUndefined.NullOrUndefined (VersionIdMarker) } ) -> ListObjectVersionsRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newListObjectsOutput' :: ( { "IsTruncated" :: NullOrUndefined.NullOrUndefined (IsTruncated) , "Marker" :: NullOrUndefined.NullOrUndefined (Marker) , "NextMarker" :: NullOrUndefined.NullOrUndefined (NextMarker) , "Contents" :: NullOrUndefined.NullOrUndefined (ObjectList) , "Name" :: NullOrUndefined.NullOrUndefined (BucketName) , "Prefix" :: NullOrUndefined.NullOrUndefined (Prefix) , "Delimiter" :: NullOrUndefined.NullOrUndefined (Delimiter) , "MaxKeys" :: NullOrUndefined.NullOrUndefined (MaxKeys) , "CommonPrefixes" :: NullOrUndefined.NullOrUndefined (CommonPrefixList) , "EncodingType" :: NullOrUndefined.NullOrUndefined (EncodingType) } -> {"IsTruncated" :: NullOrUndefined.NullOrUndefined (IsTruncated) , "Marker" :: NullOrUndefined.NullOrUndefined (Marker) , "NextMarker" :: NullOrUndefined.NullOrUndefined (NextMarker) , "Contents" :: NullOrUndefined.NullOrUndefined (ObjectList) , "Name" :: NullOrUndefined.NullOrUndefined (BucketName) , "Prefix" :: NullOrUndefined.NullOrUndefined (Prefix) , "Delimiter" :: NullOrUndefined.NullOrUndefined (Delimiter) , "MaxKeys" :: NullOrUndefined.NullOrUndefined (MaxKeys) , "CommonPrefixes" :: NullOrUndefined.NullOrUndefined (CommonPrefixList) , "EncodingType" :: NullOrUndefined.NullOrUndefined (EncodingType) } ) -> ListObjectsOutput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newListObjectsRequest' :: BucketName -> ( { "Bucket" :: (BucketName) , "Delimiter" :: NullOrUndefined.NullOrUndefined (Delimiter) , "EncodingType" :: NullOrUndefined.NullOrUndefined (EncodingType) , "Marker" :: NullOrUndefined.NullOrUndefined (Marker) , "MaxKeys" :: NullOrUndefined.NullOrUndefined (MaxKeys) , "Prefix" :: NullOrUndefined.NullOrUndefined (Prefix) , "RequestPayer" :: NullOrUndefined.NullOrUndefined (RequestPayer) } -> {"Bucket" :: (BucketName) , "Delimiter" :: NullOrUndefined.NullOrUndefined (Delimiter) , "EncodingType" :: NullOrUndefined.NullOrUndefined (EncodingType) , "Marker" :: NullOrUndefined.NullOrUndefined (Marker) , "MaxKeys" :: NullOrUndefined.NullOrUndefined (MaxKeys) , "Prefix" :: NullOrUndefined.NullOrUndefined (Prefix) , "RequestPayer" :: NullOrUndefined.NullOrUndefined (RequestPayer) } ) -> ListObjectsRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newListObjectsV2Output' :: ( { "IsTruncated" :: NullOrUndefined.NullOrUndefined (IsTruncated) , "Contents" :: NullOrUndefined.NullOrUndefined (ObjectList) , "Name" :: NullOrUndefined.NullOrUndefined (BucketName) , "Prefix" :: NullOrUndefined.NullOrUndefined (Prefix) , "Delimiter" :: NullOrUndefined.NullOrUndefined (Delimiter) , "MaxKeys" :: NullOrUndefined.NullOrUndefined (MaxKeys) , "CommonPrefixes" :: NullOrUndefined.NullOrUndefined (CommonPrefixList) , "EncodingType" :: NullOrUndefined.NullOrUndefined (EncodingType) , "KeyCount" :: NullOrUndefined.NullOrUndefined (KeyCount) , "ContinuationToken" :: NullOrUndefined.NullOrUndefined (Token) , "NextContinuationToken" :: NullOrUndefined.NullOrUndefined (NextToken) , "StartAfter" :: NullOrUndefined.NullOrUndefined (StartAfter) } -> {"IsTruncated" :: NullOrUndefined.NullOrUndefined (IsTruncated) , "Contents" :: NullOrUndefined.NullOrUndefined (ObjectList) , "Name" :: NullOrUndefined.NullOrUndefined (BucketName) , "Prefix" :: NullOrUndefined.NullOrUndefined (Prefix) , "Delimiter" :: NullOrUndefined.NullOrUndefined (Delimiter) , "MaxKeys" :: NullOrUndefined.NullOrUndefined (MaxKeys) , "CommonPrefixes" :: NullOrUndefined.NullOrUndefined (CommonPrefixList) , "EncodingType" :: NullOrUndefined.NullOrUndefined (EncodingType) , "KeyCount" :: NullOrUndefined.NullOrUndefined (KeyCount) , "ContinuationToken" :: NullOrUndefined.NullOrUndefined (Token) , "NextContinuationToken" :: NullOrUndefined.NullOrUndefined (NextToken) , "StartAfter" :: NullOrUndefined.NullOrUndefined (StartAfter) } ) -> ListObjectsV2Output
...
--   This may be useful if you need to immediately overwrite some of the optional values
newListObjectsV2Request' :: BucketName -> ( { "Bucket" :: (BucketName) , "Delimiter" :: NullOrUndefined.NullOrUndefined (Delimiter) , "EncodingType" :: NullOrUndefined.NullOrUndefined (EncodingType) , "MaxKeys" :: NullOrUndefined.NullOrUndefined (MaxKeys) , "Prefix" :: NullOrUndefined.NullOrUndefined (Prefix) , "ContinuationToken" :: NullOrUndefined.NullOrUndefined (Token) , "FetchOwner" :: NullOrUndefined.NullOrUndefined (FetchOwner) , "StartAfter" :: NullOrUndefined.NullOrUndefined (StartAfter) , "RequestPayer" :: NullOrUndefined.NullOrUndefined (RequestPayer) } -> {"Bucket" :: (BucketName) , "Delimiter" :: NullOrUndefined.NullOrUndefined (Delimiter) , "EncodingType" :: NullOrUndefined.NullOrUndefined (EncodingType) , "MaxKeys" :: NullOrUndefined.NullOrUndefined (MaxKeys) , "Prefix" :: NullOrUndefined.NullOrUndefined (Prefix) , "ContinuationToken" :: NullOrUndefined.NullOrUndefined (Token) , "FetchOwner" :: NullOrUndefined.NullOrUndefined (FetchOwner) , "StartAfter" :: NullOrUndefined.NullOrUndefined (StartAfter) , "RequestPayer" :: NullOrUndefined.NullOrUndefined (RequestPayer) } ) -> ListObjectsV2Request
...
--   This may be useful if you need to immediately overwrite some of the optional values
newListPartsOutput' :: ( { "AbortDate" :: NullOrUndefined.NullOrUndefined (AbortDate) , "AbortRuleId" :: NullOrUndefined.NullOrUndefined (AbortRuleId) , "Bucket" :: NullOrUndefined.NullOrUndefined (BucketName) , "Key" :: NullOrUndefined.NullOrUndefined (ObjectKey) , "UploadId" :: NullOrUndefined.NullOrUndefined (MultipartUploadId) , "PartNumberMarker" :: NullOrUndefined.NullOrUndefined (PartNumberMarker) , "NextPartNumberMarker" :: NullOrUndefined.NullOrUndefined (NextPartNumberMarker) , "MaxParts" :: NullOrUndefined.NullOrUndefined (MaxParts) , "IsTruncated" :: NullOrUndefined.NullOrUndefined (IsTruncated) , "Parts" :: NullOrUndefined.NullOrUndefined (Parts) , "Initiator" :: NullOrUndefined.NullOrUndefined (Initiator) , "Owner" :: NullOrUndefined.NullOrUndefined (Owner) , "StorageClass" :: NullOrUndefined.NullOrUndefined (StorageClass) , "RequestCharged" :: NullOrUndefined.NullOrUndefined (RequestCharged) } -> {"AbortDate" :: NullOrUndefined.NullOrUndefined (AbortDate) , "AbortRuleId" :: NullOrUndefined.NullOrUndefined (AbortRuleId) , "Bucket" :: NullOrUndefined.NullOrUndefined (BucketName) , "Key" :: NullOrUndefined.NullOrUndefined (ObjectKey) , "UploadId" :: NullOrUndefined.NullOrUndefined (MultipartUploadId) , "PartNumberMarker" :: NullOrUndefined.NullOrUndefined (PartNumberMarker) , "NextPartNumberMarker" :: NullOrUndefined.NullOrUndefined (NextPartNumberMarker) , "MaxParts" :: NullOrUndefined.NullOrUndefined (MaxParts) , "IsTruncated" :: NullOrUndefined.NullOrUndefined (IsTruncated) , "Parts" :: NullOrUndefined.NullOrUndefined (Parts) , "Initiator" :: NullOrUndefined.NullOrUndefined (Initiator) , "Owner" :: NullOrUndefined.NullOrUndefined (Owner) , "StorageClass" :: NullOrUndefined.NullOrUndefined (StorageClass) , "RequestCharged" :: NullOrUndefined.NullOrUndefined (RequestCharged) } ) -> ListPartsOutput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newListPartsRequest' :: BucketName -> ObjectKey -> MultipartUploadId -> ( { "Bucket" :: (BucketName) , "Key" :: (ObjectKey) , "MaxParts" :: NullOrUndefined.NullOrUndefined (MaxParts) , "PartNumberMarker" :: NullOrUndefined.NullOrUndefined (PartNumberMarker) , "UploadId" :: (MultipartUploadId) , "RequestPayer" :: NullOrUndefined.NullOrUndefined (RequestPayer) } -> {"Bucket" :: (BucketName) , "Key" :: (ObjectKey) , "MaxParts" :: NullOrUndefined.NullOrUndefined (MaxParts) , "PartNumberMarker" :: NullOrUndefined.NullOrUndefined (PartNumberMarker) , "UploadId" :: (MultipartUploadId) , "RequestPayer" :: NullOrUndefined.NullOrUndefined (RequestPayer) } ) -> ListPartsRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newLoggingEnabled' :: ( { "TargetBucket" :: NullOrUndefined.NullOrUndefined (TargetBucket) , "TargetGrants" :: NullOrUndefined.NullOrUndefined (TargetGrants) , "TargetPrefix" :: NullOrUndefined.NullOrUndefined (TargetPrefix) } -> {"TargetBucket" :: NullOrUndefined.NullOrUndefined (TargetBucket) , "TargetGrants" :: NullOrUndefined.NullOrUndefined (TargetGrants) , "TargetPrefix" :: NullOrUndefined.NullOrUndefined (TargetPrefix) } ) -> LoggingEnabled
...
--   This may be useful if you need to immediately overwrite some of the optional values
newMetadataEntry' :: ( { "Name" :: NullOrUndefined.NullOrUndefined (MetadataKey) , "Value" :: NullOrUndefined.NullOrUndefined (MetadataValue) } -> {"Name" :: NullOrUndefined.NullOrUndefined (MetadataKey) , "Value" :: NullOrUndefined.NullOrUndefined (MetadataValue) } ) -> MetadataEntry
...
--   This may be useful if you need to immediately overwrite some of the optional values
newMetricsAndOperator' :: ( { "Prefix" :: NullOrUndefined.NullOrUndefined (Prefix) , "Tags" :: NullOrUndefined.NullOrUndefined (TagSet) } -> {"Prefix" :: NullOrUndefined.NullOrUndefined (Prefix) , "Tags" :: NullOrUndefined.NullOrUndefined (TagSet) } ) -> MetricsAndOperator
...
--   This may be useful if you need to immediately overwrite some of the optional values
newMetricsConfiguration' :: MetricsId -> ( { "Id" :: (MetricsId) , "Filter" :: NullOrUndefined.NullOrUndefined (MetricsFilter) } -> {"Id" :: (MetricsId) , "Filter" :: NullOrUndefined.NullOrUndefined (MetricsFilter) } ) -> MetricsConfiguration
...
--   This may be useful if you need to immediately overwrite some of the optional values
newMetricsFilter' :: ( { "Prefix" :: NullOrUndefined.NullOrUndefined (Prefix) , "Tag" :: NullOrUndefined.NullOrUndefined (Tag) , "And" :: NullOrUndefined.NullOrUndefined (MetricsAndOperator) } -> {"Prefix" :: NullOrUndefined.NullOrUndefined (Prefix) , "Tag" :: NullOrUndefined.NullOrUndefined (Tag) , "And" :: NullOrUndefined.NullOrUndefined (MetricsAndOperator) } ) -> MetricsFilter
...
--   This may be useful if you need to immediately overwrite some of the optional values
newMultipartUpload' :: ( { "UploadId" :: NullOrUndefined.NullOrUndefined (MultipartUploadId) , "Key" :: NullOrUndefined.NullOrUndefined (ObjectKey) , "Initiated" :: NullOrUndefined.NullOrUndefined (Initiated) , "StorageClass" :: NullOrUndefined.NullOrUndefined (StorageClass) , "Owner" :: NullOrUndefined.NullOrUndefined (Owner) , "Initiator" :: NullOrUndefined.NullOrUndefined (Initiator) } -> {"UploadId" :: NullOrUndefined.NullOrUndefined (MultipartUploadId) , "Key" :: NullOrUndefined.NullOrUndefined (ObjectKey) , "Initiated" :: NullOrUndefined.NullOrUndefined (Initiated) , "StorageClass" :: NullOrUndefined.NullOrUndefined (StorageClass) , "Owner" :: NullOrUndefined.NullOrUndefined (Owner) , "Initiator" :: NullOrUndefined.NullOrUndefined (Initiator) } ) -> MultipartUpload
...
--   This may be useful if you need to immediately overwrite some of the optional values
newNoncurrentVersionExpiration' :: ( { "NoncurrentDays" :: NullOrUndefined.NullOrUndefined (Days) } -> {"NoncurrentDays" :: NullOrUndefined.NullOrUndefined (Days) } ) -> NoncurrentVersionExpiration
...
--   This may be useful if you need to immediately overwrite some of the optional values
newNoncurrentVersionTransition' :: ( { "NoncurrentDays" :: NullOrUndefined.NullOrUndefined (Days) , "StorageClass" :: NullOrUndefined.NullOrUndefined (TransitionStorageClass) } -> {"NoncurrentDays" :: NullOrUndefined.NullOrUndefined (Days) , "StorageClass" :: NullOrUndefined.NullOrUndefined (TransitionStorageClass) } ) -> NoncurrentVersionTransition
...
--   This may be useful if you need to immediately overwrite some of the optional values
newNotificationConfiguration' :: ( { "TopicConfigurations" :: NullOrUndefined.NullOrUndefined (TopicConfigurationList) , "QueueConfigurations" :: NullOrUndefined.NullOrUndefined (QueueConfigurationList) , "LambdaFunctionConfigurations" :: NullOrUndefined.NullOrUndefined (LambdaFunctionConfigurationList) } -> {"TopicConfigurations" :: NullOrUndefined.NullOrUndefined (TopicConfigurationList) , "QueueConfigurations" :: NullOrUndefined.NullOrUndefined (QueueConfigurationList) , "LambdaFunctionConfigurations" :: NullOrUndefined.NullOrUndefined (LambdaFunctionConfigurationList) } ) -> NotificationConfiguration
...
--   This may be useful if you need to immediately overwrite some of the optional values
newNotificationConfigurationDeprecated' :: ( { "TopicConfiguration" :: NullOrUndefined.NullOrUndefined (TopicConfigurationDeprecated) , "QueueConfiguration" :: NullOrUndefined.NullOrUndefined (QueueConfigurationDeprecated) , "CloudFunctionConfiguration" :: NullOrUndefined.NullOrUndefined (CloudFunctionConfiguration) } -> {"TopicConfiguration" :: NullOrUndefined.NullOrUndefined (TopicConfigurationDeprecated) , "QueueConfiguration" :: NullOrUndefined.NullOrUndefined (QueueConfigurationDeprecated) , "CloudFunctionConfiguration" :: NullOrUndefined.NullOrUndefined (CloudFunctionConfiguration) } ) -> NotificationConfigurationDeprecated
...
--   This may be useful if you need to immediately overwrite some of the optional values
newNotificationConfigurationFilter' :: ( { "Key" :: NullOrUndefined.NullOrUndefined (S3KeyFilter) } -> {"Key" :: NullOrUndefined.NullOrUndefined (S3KeyFilter) } ) -> NotificationConfigurationFilter
...
--   This may be useful if you need to immediately overwrite some of the optional values
newObject' :: ( { "Key" :: NullOrUndefined.NullOrUndefined (ObjectKey) , "LastModified" :: NullOrUndefined.NullOrUndefined (LastModified) , "ETag" :: NullOrUndefined.NullOrUndefined (ETag) , "Size" :: NullOrUndefined.NullOrUndefined (Size) , "StorageClass" :: NullOrUndefined.NullOrUndefined (ObjectStorageClass) , "Owner" :: NullOrUndefined.NullOrUndefined (Owner) } -> {"Key" :: NullOrUndefined.NullOrUndefined (ObjectKey) , "LastModified" :: NullOrUndefined.NullOrUndefined (LastModified) , "ETag" :: NullOrUndefined.NullOrUndefined (ETag) , "Size" :: NullOrUndefined.NullOrUndefined (Size) , "StorageClass" :: NullOrUndefined.NullOrUndefined (ObjectStorageClass) , "Owner" :: NullOrUndefined.NullOrUndefined (Owner) } ) -> Object
...
--   This may be useful if you need to immediately overwrite some of the optional values
newObjectIdentifier' :: ObjectKey -> ( { "Key" :: (ObjectKey) , "VersionId" :: NullOrUndefined.NullOrUndefined (ObjectVersionId) } -> {"Key" :: (ObjectKey) , "VersionId" :: NullOrUndefined.NullOrUndefined (ObjectVersionId) } ) -> ObjectIdentifier
...
--   This may be useful if you need to immediately overwrite some of the optional values
newObjectVersion' :: ( { "ETag" :: NullOrUndefined.NullOrUndefined (ETag) , "Size" :: NullOrUndefined.NullOrUndefined (Size) , "StorageClass" :: NullOrUndefined.NullOrUndefined (ObjectVersionStorageClass) , "Key" :: NullOrUndefined.NullOrUndefined (ObjectKey) , "VersionId" :: NullOrUndefined.NullOrUndefined (ObjectVersionId) , "IsLatest" :: NullOrUndefined.NullOrUndefined (IsLatest) , "LastModified" :: NullOrUndefined.NullOrUndefined (LastModified) , "Owner" :: NullOrUndefined.NullOrUndefined (Owner) } -> {"ETag" :: NullOrUndefined.NullOrUndefined (ETag) , "Size" :: NullOrUndefined.NullOrUndefined (Size) , "StorageClass" :: NullOrUndefined.NullOrUndefined (ObjectVersionStorageClass) , "Key" :: NullOrUndefined.NullOrUndefined (ObjectKey) , "VersionId" :: NullOrUndefined.NullOrUndefined (ObjectVersionId) , "IsLatest" :: NullOrUndefined.NullOrUndefined (IsLatest) , "LastModified" :: NullOrUndefined.NullOrUndefined (LastModified) , "Owner" :: NullOrUndefined.NullOrUndefined (Owner) } ) -> ObjectVersion
...
--   This may be useful if you need to immediately overwrite some of the optional values
newOwner' :: ( { "DisplayName" :: NullOrUndefined.NullOrUndefined (DisplayName) , "ID" :: NullOrUndefined.NullOrUndefined (ID) } -> {"DisplayName" :: NullOrUndefined.NullOrUndefined (DisplayName) , "ID" :: NullOrUndefined.NullOrUndefined (ID) } ) -> Owner
...
--   This may be useful if you need to immediately overwrite some of the optional values
newPart' :: ( { "PartNumber" :: NullOrUndefined.NullOrUndefined (PartNumber) , "LastModified" :: NullOrUndefined.NullOrUndefined (LastModified) , "ETag" :: NullOrUndefined.NullOrUndefined (ETag) , "Size" :: NullOrUndefined.NullOrUndefined (Size) } -> {"PartNumber" :: NullOrUndefined.NullOrUndefined (PartNumber) , "LastModified" :: NullOrUndefined.NullOrUndefined (LastModified) , "ETag" :: NullOrUndefined.NullOrUndefined (ETag) , "Size" :: NullOrUndefined.NullOrUndefined (Size) } ) -> Part
...
--   This may be useful if you need to immediately overwrite some of the optional values
newPutBucketAclRequest' :: BucketName -> ( { "ACL" :: NullOrUndefined.NullOrUndefined (BucketCannedACL) , "AccessControlPolicy" :: NullOrUndefined.NullOrUndefined (AccessControlPolicy) , "Bucket" :: (BucketName) , "ContentMD5" :: NullOrUndefined.NullOrUndefined (ContentMD5) , "GrantFullControl" :: NullOrUndefined.NullOrUndefined (GrantFullControl) , "GrantRead" :: NullOrUndefined.NullOrUndefined (GrantRead) , "GrantReadACP" :: NullOrUndefined.NullOrUndefined (GrantReadACP) , "GrantWrite" :: NullOrUndefined.NullOrUndefined (GrantWrite) , "GrantWriteACP" :: NullOrUndefined.NullOrUndefined (GrantWriteACP) } -> {"ACL" :: NullOrUndefined.NullOrUndefined (BucketCannedACL) , "AccessControlPolicy" :: NullOrUndefined.NullOrUndefined (AccessControlPolicy) , "Bucket" :: (BucketName) , "ContentMD5" :: NullOrUndefined.NullOrUndefined (ContentMD5) , "GrantFullControl" :: NullOrUndefined.NullOrUndefined (GrantFullControl) , "GrantRead" :: NullOrUndefined.NullOrUndefined (GrantRead) , "GrantReadACP" :: NullOrUndefined.NullOrUndefined (GrantReadACP) , "GrantWrite" :: NullOrUndefined.NullOrUndefined (GrantWrite) , "GrantWriteACP" :: NullOrUndefined.NullOrUndefined (GrantWriteACP) } ) -> PutBucketAclRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newPutBucketCorsRequest' :: BucketName -> CORSConfiguration -> ( { "Bucket" :: (BucketName) , "CORSConfiguration" :: (CORSConfiguration) , "ContentMD5" :: NullOrUndefined.NullOrUndefined (ContentMD5) } -> {"Bucket" :: (BucketName) , "CORSConfiguration" :: (CORSConfiguration) , "ContentMD5" :: NullOrUndefined.NullOrUndefined (ContentMD5) } ) -> PutBucketCorsRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newPutBucketEncryptionRequest' :: BucketName -> ServerSideEncryptionConfiguration -> ( { "Bucket" :: (BucketName) , "ContentMD5" :: NullOrUndefined.NullOrUndefined (ContentMD5) , "ServerSideEncryptionConfiguration" :: (ServerSideEncryptionConfiguration) } -> {"Bucket" :: (BucketName) , "ContentMD5" :: NullOrUndefined.NullOrUndefined (ContentMD5) , "ServerSideEncryptionConfiguration" :: (ServerSideEncryptionConfiguration) } ) -> PutBucketEncryptionRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newPutBucketLifecycleConfigurationRequest' :: BucketName -> ( { "Bucket" :: (BucketName) , "LifecycleConfiguration" :: NullOrUndefined.NullOrUndefined (BucketLifecycleConfiguration) } -> {"Bucket" :: (BucketName) , "LifecycleConfiguration" :: NullOrUndefined.NullOrUndefined (BucketLifecycleConfiguration) } ) -> PutBucketLifecycleConfigurationRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newPutBucketLifecycleRequest' :: BucketName -> ( { "Bucket" :: (BucketName) , "ContentMD5" :: NullOrUndefined.NullOrUndefined (ContentMD5) , "LifecycleConfiguration" :: NullOrUndefined.NullOrUndefined (LifecycleConfiguration) } -> {"Bucket" :: (BucketName) , "ContentMD5" :: NullOrUndefined.NullOrUndefined (ContentMD5) , "LifecycleConfiguration" :: NullOrUndefined.NullOrUndefined (LifecycleConfiguration) } ) -> PutBucketLifecycleRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newPutBucketLoggingRequest' :: BucketName -> BucketLoggingStatus -> ( { "Bucket" :: (BucketName) , "BucketLoggingStatus" :: (BucketLoggingStatus) , "ContentMD5" :: NullOrUndefined.NullOrUndefined (ContentMD5) } -> {"Bucket" :: (BucketName) , "BucketLoggingStatus" :: (BucketLoggingStatus) , "ContentMD5" :: NullOrUndefined.NullOrUndefined (ContentMD5) } ) -> PutBucketLoggingRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newPutBucketNotificationRequest' :: BucketName -> NotificationConfigurationDeprecated -> ( { "Bucket" :: (BucketName) , "ContentMD5" :: NullOrUndefined.NullOrUndefined (ContentMD5) , "NotificationConfiguration" :: (NotificationConfigurationDeprecated) } -> {"Bucket" :: (BucketName) , "ContentMD5" :: NullOrUndefined.NullOrUndefined (ContentMD5) , "NotificationConfiguration" :: (NotificationConfigurationDeprecated) } ) -> PutBucketNotificationRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newPutBucketPolicyRequest' :: BucketName -> Policy -> ( { "Bucket" :: (BucketName) , "ContentMD5" :: NullOrUndefined.NullOrUndefined (ContentMD5) , "ConfirmRemoveSelfBucketAccess" :: NullOrUndefined.NullOrUndefined (ConfirmRemoveSelfBucketAccess) , "Policy" :: (Policy) } -> {"Bucket" :: (BucketName) , "ContentMD5" :: NullOrUndefined.NullOrUndefined (ContentMD5) , "ConfirmRemoveSelfBucketAccess" :: NullOrUndefined.NullOrUndefined (ConfirmRemoveSelfBucketAccess) , "Policy" :: (Policy) } ) -> PutBucketPolicyRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newPutBucketReplicationRequest' :: BucketName -> ReplicationConfiguration -> ( { "Bucket" :: (BucketName) , "ContentMD5" :: NullOrUndefined.NullOrUndefined (ContentMD5) , "ReplicationConfiguration" :: (ReplicationConfiguration) } -> {"Bucket" :: (BucketName) , "ContentMD5" :: NullOrUndefined.NullOrUndefined (ContentMD5) , "ReplicationConfiguration" :: (ReplicationConfiguration) } ) -> PutBucketReplicationRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newPutBucketRequestPaymentRequest' :: BucketName -> RequestPaymentConfiguration -> ( { "Bucket" :: (BucketName) , "ContentMD5" :: NullOrUndefined.NullOrUndefined (ContentMD5) , "RequestPaymentConfiguration" :: (RequestPaymentConfiguration) } -> {"Bucket" :: (BucketName) , "ContentMD5" :: NullOrUndefined.NullOrUndefined (ContentMD5) , "RequestPaymentConfiguration" :: (RequestPaymentConfiguration) } ) -> PutBucketRequestPaymentRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newPutBucketTaggingRequest' :: BucketName -> Tagging -> ( { "Bucket" :: (BucketName) , "ContentMD5" :: NullOrUndefined.NullOrUndefined (ContentMD5) , "Tagging" :: (Tagging) } -> {"Bucket" :: (BucketName) , "ContentMD5" :: NullOrUndefined.NullOrUndefined (ContentMD5) , "Tagging" :: (Tagging) } ) -> PutBucketTaggingRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newPutBucketVersioningRequest' :: BucketName -> VersioningConfiguration -> ( { "Bucket" :: (BucketName) , "ContentMD5" :: NullOrUndefined.NullOrUndefined (ContentMD5) , "MFA" :: NullOrUndefined.NullOrUndefined (MFA) , "VersioningConfiguration" :: (VersioningConfiguration) } -> {"Bucket" :: (BucketName) , "ContentMD5" :: NullOrUndefined.NullOrUndefined (ContentMD5) , "MFA" :: NullOrUndefined.NullOrUndefined (MFA) , "VersioningConfiguration" :: (VersioningConfiguration) } ) -> PutBucketVersioningRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newPutBucketWebsiteRequest' :: BucketName -> WebsiteConfiguration -> ( { "Bucket" :: (BucketName) , "ContentMD5" :: NullOrUndefined.NullOrUndefined (ContentMD5) , "WebsiteConfiguration" :: (WebsiteConfiguration) } -> {"Bucket" :: (BucketName) , "ContentMD5" :: NullOrUndefined.NullOrUndefined (ContentMD5) , "WebsiteConfiguration" :: (WebsiteConfiguration) } ) -> PutBucketWebsiteRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newPutObjectAclOutput' :: ( { "RequestCharged" :: NullOrUndefined.NullOrUndefined (RequestCharged) } -> {"RequestCharged" :: NullOrUndefined.NullOrUndefined (RequestCharged) } ) -> PutObjectAclOutput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newPutObjectAclRequest' :: BucketName -> ObjectKey -> ( { "ACL" :: NullOrUndefined.NullOrUndefined (ObjectCannedACL) , "AccessControlPolicy" :: NullOrUndefined.NullOrUndefined (AccessControlPolicy) , "Bucket" :: (BucketName) , "ContentMD5" :: NullOrUndefined.NullOrUndefined (ContentMD5) , "GrantFullControl" :: NullOrUndefined.NullOrUndefined (GrantFullControl) , "GrantRead" :: NullOrUndefined.NullOrUndefined (GrantRead) , "GrantReadACP" :: NullOrUndefined.NullOrUndefined (GrantReadACP) , "GrantWrite" :: NullOrUndefined.NullOrUndefined (GrantWrite) , "GrantWriteACP" :: NullOrUndefined.NullOrUndefined (GrantWriteACP) , "Key" :: (ObjectKey) , "RequestPayer" :: NullOrUndefined.NullOrUndefined (RequestPayer) , "VersionId" :: NullOrUndefined.NullOrUndefined (ObjectVersionId) } -> {"ACL" :: NullOrUndefined.NullOrUndefined (ObjectCannedACL) , "AccessControlPolicy" :: NullOrUndefined.NullOrUndefined (AccessControlPolicy) , "Bucket" :: (BucketName) , "ContentMD5" :: NullOrUndefined.NullOrUndefined (ContentMD5) , "GrantFullControl" :: NullOrUndefined.NullOrUndefined (GrantFullControl) , "GrantRead" :: NullOrUndefined.NullOrUndefined (GrantRead) , "GrantReadACP" :: NullOrUndefined.NullOrUndefined (GrantReadACP) , "GrantWrite" :: NullOrUndefined.NullOrUndefined (GrantWrite) , "GrantWriteACP" :: NullOrUndefined.NullOrUndefined (GrantWriteACP) , "Key" :: (ObjectKey) , "RequestPayer" :: NullOrUndefined.NullOrUndefined (RequestPayer) , "VersionId" :: NullOrUndefined.NullOrUndefined (ObjectVersionId) } ) -> PutObjectAclRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newPutObjectOutput' :: ( { "Expiration" :: NullOrUndefined.NullOrUndefined (Expiration) , "ETag" :: NullOrUndefined.NullOrUndefined (ETag) , "ServerSideEncryption" :: NullOrUndefined.NullOrUndefined (ServerSideEncryption) , "VersionId" :: NullOrUndefined.NullOrUndefined (ObjectVersionId) , "SSECustomerAlgorithm" :: NullOrUndefined.NullOrUndefined (SSECustomerAlgorithm) , "SSECustomerKeyMD5" :: NullOrUndefined.NullOrUndefined (SSECustomerKeyMD5) , "SSEKMSKeyId" :: NullOrUndefined.NullOrUndefined (SSEKMSKeyId) , "RequestCharged" :: NullOrUndefined.NullOrUndefined (RequestCharged) } -> {"Expiration" :: NullOrUndefined.NullOrUndefined (Expiration) , "ETag" :: NullOrUndefined.NullOrUndefined (ETag) , "ServerSideEncryption" :: NullOrUndefined.NullOrUndefined (ServerSideEncryption) , "VersionId" :: NullOrUndefined.NullOrUndefined (ObjectVersionId) , "SSECustomerAlgorithm" :: NullOrUndefined.NullOrUndefined (SSECustomerAlgorithm) , "SSECustomerKeyMD5" :: NullOrUndefined.NullOrUndefined (SSECustomerKeyMD5) , "SSEKMSKeyId" :: NullOrUndefined.NullOrUndefined (SSEKMSKeyId) , "RequestCharged" :: NullOrUndefined.NullOrUndefined (RequestCharged) } ) -> PutObjectOutput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newPutObjectRequest' :: BucketName -> ObjectKey -> ( { "ACL" :: NullOrUndefined.NullOrUndefined (ObjectCannedACL) , "Body" :: NullOrUndefined.NullOrUndefined (Body) , "Bucket" :: (BucketName) , "CacheControl" :: NullOrUndefined.NullOrUndefined (CacheControl) , "ContentDisposition" :: NullOrUndefined.NullOrUndefined (ContentDisposition) , "ContentEncoding" :: NullOrUndefined.NullOrUndefined (ContentEncoding) , "ContentLanguage" :: NullOrUndefined.NullOrUndefined (ContentLanguage) , "ContentLength" :: NullOrUndefined.NullOrUndefined (ContentLength) , "ContentMD5" :: NullOrUndefined.NullOrUndefined (ContentMD5) , "ContentType" :: NullOrUndefined.NullOrUndefined (ContentType) , "Expires" :: NullOrUndefined.NullOrUndefined (Expires) , "GrantFullControl" :: NullOrUndefined.NullOrUndefined (GrantFullControl) , "GrantRead" :: NullOrUndefined.NullOrUndefined (GrantRead) , "GrantReadACP" :: NullOrUndefined.NullOrUndefined (GrantReadACP) , "GrantWriteACP" :: NullOrUndefined.NullOrUndefined (GrantWriteACP) , "Key" :: (ObjectKey) , "Metadata" :: NullOrUndefined.NullOrUndefined (Metadata) , "ServerSideEncryption" :: NullOrUndefined.NullOrUndefined (ServerSideEncryption) , "StorageClass" :: NullOrUndefined.NullOrUndefined (StorageClass) , "WebsiteRedirectLocation" :: NullOrUndefined.NullOrUndefined (WebsiteRedirectLocation) , "SSECustomerAlgorithm" :: NullOrUndefined.NullOrUndefined (SSECustomerAlgorithm) , "SSECustomerKey" :: NullOrUndefined.NullOrUndefined (SSECustomerKey) , "SSECustomerKeyMD5" :: NullOrUndefined.NullOrUndefined (SSECustomerKeyMD5) , "SSEKMSKeyId" :: NullOrUndefined.NullOrUndefined (SSEKMSKeyId) , "RequestPayer" :: NullOrUndefined.NullOrUndefined (RequestPayer) , "Tagging" :: NullOrUndefined.NullOrUndefined (TaggingHeader) } -> {"ACL" :: NullOrUndefined.NullOrUndefined (ObjectCannedACL) , "Body" :: NullOrUndefined.NullOrUndefined (Body) , "Bucket" :: (BucketName) , "CacheControl" :: NullOrUndefined.NullOrUndefined (CacheControl) , "ContentDisposition" :: NullOrUndefined.NullOrUndefined (ContentDisposition) , "ContentEncoding" :: NullOrUndefined.NullOrUndefined (ContentEncoding) , "ContentLanguage" :: NullOrUndefined.NullOrUndefined (ContentLanguage) , "ContentLength" :: NullOrUndefined.NullOrUndefined (ContentLength) , "ContentMD5" :: NullOrUndefined.NullOrUndefined (ContentMD5) , "ContentType" :: NullOrUndefined.NullOrUndefined (ContentType) , "Expires" :: NullOrUndefined.NullOrUndefined (Expires) , "GrantFullControl" :: NullOrUndefined.NullOrUndefined (GrantFullControl) , "GrantRead" :: NullOrUndefined.NullOrUndefined (GrantRead) , "GrantReadACP" :: NullOrUndefined.NullOrUndefined (GrantReadACP) , "GrantWriteACP" :: NullOrUndefined.NullOrUndefined (GrantWriteACP) , "Key" :: (ObjectKey) , "Metadata" :: NullOrUndefined.NullOrUndefined (Metadata) , "ServerSideEncryption" :: NullOrUndefined.NullOrUndefined (ServerSideEncryption) , "StorageClass" :: NullOrUndefined.NullOrUndefined (StorageClass) , "WebsiteRedirectLocation" :: NullOrUndefined.NullOrUndefined (WebsiteRedirectLocation) , "SSECustomerAlgorithm" :: NullOrUndefined.NullOrUndefined (SSECustomerAlgorithm) , "SSECustomerKey" :: NullOrUndefined.NullOrUndefined (SSECustomerKey) , "SSECustomerKeyMD5" :: NullOrUndefined.NullOrUndefined (SSECustomerKeyMD5) , "SSEKMSKeyId" :: NullOrUndefined.NullOrUndefined (SSEKMSKeyId) , "RequestPayer" :: NullOrUndefined.NullOrUndefined (RequestPayer) , "Tagging" :: NullOrUndefined.NullOrUndefined (TaggingHeader) } ) -> PutObjectRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newPutObjectTaggingOutput' :: ( { "VersionId" :: NullOrUndefined.NullOrUndefined (ObjectVersionId) } -> {"VersionId" :: NullOrUndefined.NullOrUndefined (ObjectVersionId) } ) -> PutObjectTaggingOutput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newPutObjectTaggingRequest' :: BucketName -> ObjectKey -> Tagging -> ( { "Bucket" :: (BucketName) , "Key" :: (ObjectKey) , "VersionId" :: NullOrUndefined.NullOrUndefined (ObjectVersionId) , "ContentMD5" :: NullOrUndefined.NullOrUndefined (ContentMD5) , "Tagging" :: (Tagging) } -> {"Bucket" :: (BucketName) , "Key" :: (ObjectKey) , "VersionId" :: NullOrUndefined.NullOrUndefined (ObjectVersionId) , "ContentMD5" :: NullOrUndefined.NullOrUndefined (ContentMD5) , "Tagging" :: (Tagging) } ) -> PutObjectTaggingRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newQueueConfiguration' :: EventList -> QueueArn -> ( { "Id" :: NullOrUndefined.NullOrUndefined (NotificationId) , "QueueArn" :: (QueueArn) , "Events" :: (EventList) , "Filter" :: NullOrUndefined.NullOrUndefined (NotificationConfigurationFilter) } -> {"Id" :: NullOrUndefined.NullOrUndefined (NotificationId) , "QueueArn" :: (QueueArn) , "Events" :: (EventList) , "Filter" :: NullOrUndefined.NullOrUndefined (NotificationConfigurationFilter) } ) -> QueueConfiguration
...
--   This may be useful if you need to immediately overwrite some of the optional values
newQueueConfigurationDeprecated' :: ( { "Id" :: NullOrUndefined.NullOrUndefined (NotificationId) , "Event" :: NullOrUndefined.NullOrUndefined (Event) , "Events" :: NullOrUndefined.NullOrUndefined (EventList) , "Queue" :: NullOrUndefined.NullOrUndefined (QueueArn) } -> {"Id" :: NullOrUndefined.NullOrUndefined (NotificationId) , "Event" :: NullOrUndefined.NullOrUndefined (Event) , "Events" :: NullOrUndefined.NullOrUndefined (EventList) , "Queue" :: NullOrUndefined.NullOrUndefined (QueueArn) } ) -> QueueConfigurationDeprecated
...
--   This may be useful if you need to immediately overwrite some of the optional values
newRedirect' :: ( { "HostName" :: NullOrUndefined.NullOrUndefined (HostName) , "HttpRedirectCode" :: NullOrUndefined.NullOrUndefined (HttpRedirectCode) , "Protocol" :: NullOrUndefined.NullOrUndefined (Protocol) , "ReplaceKeyPrefixWith" :: NullOrUndefined.NullOrUndefined (ReplaceKeyPrefixWith) , "ReplaceKeyWith" :: NullOrUndefined.NullOrUndefined (ReplaceKeyWith) } -> {"HostName" :: NullOrUndefined.NullOrUndefined (HostName) , "HttpRedirectCode" :: NullOrUndefined.NullOrUndefined (HttpRedirectCode) , "Protocol" :: NullOrUndefined.NullOrUndefined (Protocol) , "ReplaceKeyPrefixWith" :: NullOrUndefined.NullOrUndefined (ReplaceKeyPrefixWith) , "ReplaceKeyWith" :: NullOrUndefined.NullOrUndefined (ReplaceKeyWith) } ) -> Redirect
...
--   This may be useful if you need to immediately overwrite some of the optional values
newRedirectAllRequestsTo' :: HostName -> ( { "HostName" :: (HostName) , "Protocol" :: NullOrUndefined.NullOrUndefined (Protocol) } -> {"HostName" :: (HostName) , "Protocol" :: NullOrUndefined.NullOrUndefined (Protocol) } ) -> RedirectAllRequestsTo
...
--   This may be useful if you need to immediately overwrite some of the optional values
newReplicationRule' :: Destination -> Prefix -> ReplicationRuleStatus -> ( { "ID" :: NullOrUndefined.NullOrUndefined (ID) , "Prefix" :: (Prefix) , "Status" :: (ReplicationRuleStatus) , "SourceSelectionCriteria" :: NullOrUndefined.NullOrUndefined (SourceSelectionCriteria) , "Destination" :: (Destination) } -> {"ID" :: NullOrUndefined.NullOrUndefined (ID) , "Prefix" :: (Prefix) , "Status" :: (ReplicationRuleStatus) , "SourceSelectionCriteria" :: NullOrUndefined.NullOrUndefined (SourceSelectionCriteria) , "Destination" :: (Destination) } ) -> ReplicationRule
...
--   This may be useful if you need to immediately overwrite some of the optional values
newRestoreObjectOutput' :: ( { "RequestCharged" :: NullOrUndefined.NullOrUndefined (RequestCharged) , "RestoreOutputPath" :: NullOrUndefined.NullOrUndefined (RestoreOutputPath) } -> {"RequestCharged" :: NullOrUndefined.NullOrUndefined (RequestCharged) , "RestoreOutputPath" :: NullOrUndefined.NullOrUndefined (RestoreOutputPath) } ) -> RestoreObjectOutput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newRestoreRequest' :: ( { "Days" :: NullOrUndefined.NullOrUndefined (Days) , "GlacierJobParameters" :: NullOrUndefined.NullOrUndefined (GlacierJobParameters) , "Type" :: NullOrUndefined.NullOrUndefined (RestoreRequestType) , "Tier" :: NullOrUndefined.NullOrUndefined (Tier) , "Description" :: NullOrUndefined.NullOrUndefined (Description) , "SelectParameters" :: NullOrUndefined.NullOrUndefined (SelectParameters) , "OutputLocation" :: NullOrUndefined.NullOrUndefined (OutputLocation) } -> {"Days" :: NullOrUndefined.NullOrUndefined (Days) , "GlacierJobParameters" :: NullOrUndefined.NullOrUndefined (GlacierJobParameters) , "Type" :: NullOrUndefined.NullOrUndefined (RestoreRequestType) , "Tier" :: NullOrUndefined.NullOrUndefined (Tier) , "Description" :: NullOrUndefined.NullOrUndefined (Description) , "SelectParameters" :: NullOrUndefined.NullOrUndefined (SelectParameters) , "OutputLocation" :: NullOrUndefined.NullOrUndefined (OutputLocation) } ) -> RestoreRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newRoutingRule' :: Redirect -> ( { "Condition" :: NullOrUndefined.NullOrUndefined (Condition) , "Redirect" :: (Redirect) } -> {"Condition" :: NullOrUndefined.NullOrUndefined (Condition) , "Redirect" :: (Redirect) } ) -> RoutingRule
...
--   This may be useful if you need to immediately overwrite some of the optional values
newRule' :: Prefix -> ExpirationStatus -> ( { "Expiration" :: NullOrUndefined.NullOrUndefined (LifecycleExpiration) , "ID" :: NullOrUndefined.NullOrUndefined (ID) , "Prefix" :: (Prefix) , "Status" :: (ExpirationStatus) , "Transition" :: NullOrUndefined.NullOrUndefined (Transition) , "NoncurrentVersionTransition" :: NullOrUndefined.NullOrUndefined (NoncurrentVersionTransition) , "NoncurrentVersionExpiration" :: NullOrUndefined.NullOrUndefined (NoncurrentVersionExpiration) , "AbortIncompleteMultipartUpload" :: NullOrUndefined.NullOrUndefined (AbortIncompleteMultipartUpload) } -> {"Expiration" :: NullOrUndefined.NullOrUndefined (LifecycleExpiration) , "ID" :: NullOrUndefined.NullOrUndefined (ID) , "Prefix" :: (Prefix) , "Status" :: (ExpirationStatus) , "Transition" :: NullOrUndefined.NullOrUndefined (Transition) , "NoncurrentVersionTransition" :: NullOrUndefined.NullOrUndefined (NoncurrentVersionTransition) , "NoncurrentVersionExpiration" :: NullOrUndefined.NullOrUndefined (NoncurrentVersionExpiration) , "AbortIncompleteMultipartUpload" :: NullOrUndefined.NullOrUndefined (AbortIncompleteMultipartUpload) } ) -> Rule
...
--   This may be useful if you need to immediately overwrite some of the optional values
newS3KeyFilter' :: ( { "FilterRules" :: NullOrUndefined.NullOrUndefined (FilterRuleList) } -> {"FilterRules" :: NullOrUndefined.NullOrUndefined (FilterRuleList) } ) -> S3KeyFilter
...
--   This may be useful if you need to immediately overwrite some of the optional values
newS3Location' :: BucketName -> LocationPrefix -> ( { "BucketName" :: (BucketName) , "Prefix" :: (LocationPrefix) , "Encryption" :: NullOrUndefined.NullOrUndefined (Encryption) , "CannedACL" :: NullOrUndefined.NullOrUndefined (ObjectCannedACL) , "AccessControlList" :: NullOrUndefined.NullOrUndefined (Grants) , "Tagging" :: NullOrUndefined.NullOrUndefined (Tagging) , "UserMetadata" :: NullOrUndefined.NullOrUndefined (UserMetadata) , "StorageClass" :: NullOrUndefined.NullOrUndefined (StorageClass) } -> {"BucketName" :: (BucketName) , "Prefix" :: (LocationPrefix) , "Encryption" :: NullOrUndefined.NullOrUndefined (Encryption) , "CannedACL" :: NullOrUndefined.NullOrUndefined (ObjectCannedACL) , "AccessControlList" :: NullOrUndefined.NullOrUndefined (Grants) , "Tagging" :: NullOrUndefined.NullOrUndefined (Tagging) , "UserMetadata" :: NullOrUndefined.NullOrUndefined (UserMetadata) , "StorageClass" :: NullOrUndefined.NullOrUndefined (StorageClass) } ) -> S3Location
...
--   This may be useful if you need to immediately overwrite some of the optional values
newServerSideEncryptionByDefault' :: ServerSideEncryption -> ( { "SSEAlgorithm" :: (ServerSideEncryption) , "KMSMasterKeyID" :: NullOrUndefined.NullOrUndefined (SSEKMSKeyId) } -> {"SSEAlgorithm" :: (ServerSideEncryption) , "KMSMasterKeyID" :: NullOrUndefined.NullOrUndefined (SSEKMSKeyId) } ) -> ServerSideEncryptionByDefault
...
--   This may be useful if you need to immediately overwrite some of the optional values
newServerSideEncryptionRule' :: ( { "ApplyServerSideEncryptionByDefault" :: NullOrUndefined.NullOrUndefined (ServerSideEncryptionByDefault) } -> {"ApplyServerSideEncryptionByDefault" :: NullOrUndefined.NullOrUndefined (ServerSideEncryptionByDefault) } ) -> ServerSideEncryptionRule
...
--   This may be useful if you need to immediately overwrite some of the optional values
newSourceSelectionCriteria' :: ( { "SseKmsEncryptedObjects" :: NullOrUndefined.NullOrUndefined (SseKmsEncryptedObjects) } -> {"SseKmsEncryptedObjects" :: NullOrUndefined.NullOrUndefined (SseKmsEncryptedObjects) } ) -> SourceSelectionCriteria
...
--   This may be useful if you need to immediately overwrite some of the optional values
newStorageClassAnalysis' :: ( { "DataExport" :: NullOrUndefined.NullOrUndefined (StorageClassAnalysisDataExport) } -> {"DataExport" :: NullOrUndefined.NullOrUndefined (StorageClassAnalysisDataExport) } ) -> StorageClassAnalysis
...
--   This may be useful if you need to immediately overwrite some of the optional values
newTargetGrant' :: ( { "Grantee" :: NullOrUndefined.NullOrUndefined (Grantee) , "Permission" :: NullOrUndefined.NullOrUndefined (BucketLogsPermission) } -> {"Grantee" :: NullOrUndefined.NullOrUndefined (Grantee) , "Permission" :: NullOrUndefined.NullOrUndefined (BucketLogsPermission) } ) -> TargetGrant
...
--   This may be useful if you need to immediately overwrite some of the optional values
newTopicConfiguration' :: EventList -> TopicArn -> ( { "Id" :: NullOrUndefined.NullOrUndefined (NotificationId) , "TopicArn" :: (TopicArn) , "Events" :: (EventList) , "Filter" :: NullOrUndefined.NullOrUndefined (NotificationConfigurationFilter) } -> {"Id" :: NullOrUndefined.NullOrUndefined (NotificationId) , "TopicArn" :: (TopicArn) , "Events" :: (EventList) , "Filter" :: NullOrUndefined.NullOrUndefined (NotificationConfigurationFilter) } ) -> TopicConfiguration
...
--   This may be useful if you need to immediately overwrite some of the optional values
newTopicConfigurationDeprecated' :: ( { "Id" :: NullOrUndefined.NullOrUndefined (NotificationId) , "Events" :: NullOrUndefined.NullOrUndefined (EventList) , "Event" :: NullOrUndefined.NullOrUndefined (Event) , "Topic" :: NullOrUndefined.NullOrUndefined (TopicArn) } -> {"Id" :: NullOrUndefined.NullOrUndefined (NotificationId) , "Events" :: NullOrUndefined.NullOrUndefined (EventList) , "Event" :: NullOrUndefined.NullOrUndefined (Event) , "Topic" :: NullOrUndefined.NullOrUndefined (TopicArn) } ) -> TopicConfigurationDeprecated
...
--   This may be useful if you need to immediately overwrite some of the optional values
newTransition' :: ( { "Date" :: NullOrUndefined.NullOrUndefined (Date) , "Days" :: NullOrUndefined.NullOrUndefined (Days) , "StorageClass" :: NullOrUndefined.NullOrUndefined (TransitionStorageClass) } -> {"Date" :: NullOrUndefined.NullOrUndefined (Date) , "Days" :: NullOrUndefined.NullOrUndefined (Days) , "StorageClass" :: NullOrUndefined.NullOrUndefined (TransitionStorageClass) } ) -> Transition
...
--   This may be useful if you need to immediately overwrite some of the optional values
newUploadPartCopyOutput' :: ( { "CopySourceVersionId" :: NullOrUndefined.NullOrUndefined (CopySourceVersionId) , "CopyPartResult" :: NullOrUndefined.NullOrUndefined (CopyPartResult) , "ServerSideEncryption" :: NullOrUndefined.NullOrUndefined (ServerSideEncryption) , "SSECustomerAlgorithm" :: NullOrUndefined.NullOrUndefined (SSECustomerAlgorithm) , "SSECustomerKeyMD5" :: NullOrUndefined.NullOrUndefined (SSECustomerKeyMD5) , "SSEKMSKeyId" :: NullOrUndefined.NullOrUndefined (SSEKMSKeyId) , "RequestCharged" :: NullOrUndefined.NullOrUndefined (RequestCharged) } -> {"CopySourceVersionId" :: NullOrUndefined.NullOrUndefined (CopySourceVersionId) , "CopyPartResult" :: NullOrUndefined.NullOrUndefined (CopyPartResult) , "ServerSideEncryption" :: NullOrUndefined.NullOrUndefined (ServerSideEncryption) , "SSECustomerAlgorithm" :: NullOrUndefined.NullOrUndefined (SSECustomerAlgorithm) , "SSECustomerKeyMD5" :: NullOrUndefined.NullOrUndefined (SSECustomerKeyMD5) , "SSEKMSKeyId" :: NullOrUndefined.NullOrUndefined (SSEKMSKeyId) , "RequestCharged" :: NullOrUndefined.NullOrUndefined (RequestCharged) } ) -> UploadPartCopyOutput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newUploadPartCopyRequest' :: BucketName -> CopySource -> ObjectKey -> PartNumber -> MultipartUploadId -> ( { "Bucket" :: (BucketName) , "CopySource" :: (CopySource) , "CopySourceIfMatch" :: NullOrUndefined.NullOrUndefined (CopySourceIfMatch) , "CopySourceIfModifiedSince" :: NullOrUndefined.NullOrUndefined (CopySourceIfModifiedSince) , "CopySourceIfNoneMatch" :: NullOrUndefined.NullOrUndefined (CopySourceIfNoneMatch) , "CopySourceIfUnmodifiedSince" :: NullOrUndefined.NullOrUndefined (CopySourceIfUnmodifiedSince) , "CopySourceRange" :: NullOrUndefined.NullOrUndefined (CopySourceRange) , "Key" :: (ObjectKey) , "PartNumber" :: (PartNumber) , "UploadId" :: (MultipartUploadId) , "SSECustomerAlgorithm" :: NullOrUndefined.NullOrUndefined (SSECustomerAlgorithm) , "SSECustomerKey" :: NullOrUndefined.NullOrUndefined (SSECustomerKey) , "SSECustomerKeyMD5" :: NullOrUndefined.NullOrUndefined (SSECustomerKeyMD5) , "CopySourceSSECustomerAlgorithm" :: NullOrUndefined.NullOrUndefined (CopySourceSSECustomerAlgorithm) , "CopySourceSSECustomerKey" :: NullOrUndefined.NullOrUndefined (CopySourceSSECustomerKey) , "CopySourceSSECustomerKeyMD5" :: NullOrUndefined.NullOrUndefined (CopySourceSSECustomerKeyMD5) , "RequestPayer" :: NullOrUndefined.NullOrUndefined (RequestPayer) } -> {"Bucket" :: (BucketName) , "CopySource" :: (CopySource) , "CopySourceIfMatch" :: NullOrUndefined.NullOrUndefined (CopySourceIfMatch) , "CopySourceIfModifiedSince" :: NullOrUndefined.NullOrUndefined (CopySourceIfModifiedSince) , "CopySourceIfNoneMatch" :: NullOrUndefined.NullOrUndefined (CopySourceIfNoneMatch) , "CopySourceIfUnmodifiedSince" :: NullOrUndefined.NullOrUndefined (CopySourceIfUnmodifiedSince) , "CopySourceRange" :: NullOrUndefined.NullOrUndefined (CopySourceRange) , "Key" :: (ObjectKey) , "PartNumber" :: (PartNumber) , "UploadId" :: (MultipartUploadId) , "SSECustomerAlgorithm" :: NullOrUndefined.NullOrUndefined (SSECustomerAlgorithm) , "SSECustomerKey" :: NullOrUndefined.NullOrUndefined (SSECustomerKey) , "SSECustomerKeyMD5" :: NullOrUndefined.NullOrUndefined (SSECustomerKeyMD5) , "CopySourceSSECustomerAlgorithm" :: NullOrUndefined.NullOrUndefined (CopySourceSSECustomerAlgorithm) , "CopySourceSSECustomerKey" :: NullOrUndefined.NullOrUndefined (CopySourceSSECustomerKey) , "CopySourceSSECustomerKeyMD5" :: NullOrUndefined.NullOrUndefined (CopySourceSSECustomerKeyMD5) , "RequestPayer" :: NullOrUndefined.NullOrUndefined (RequestPayer) } ) -> UploadPartCopyRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newUploadPartOutput' :: ( { "ServerSideEncryption" :: NullOrUndefined.NullOrUndefined (ServerSideEncryption) , "ETag" :: NullOrUndefined.NullOrUndefined (ETag) , "SSECustomerAlgorithm" :: NullOrUndefined.NullOrUndefined (SSECustomerAlgorithm) , "SSECustomerKeyMD5" :: NullOrUndefined.NullOrUndefined (SSECustomerKeyMD5) , "SSEKMSKeyId" :: NullOrUndefined.NullOrUndefined (SSEKMSKeyId) , "RequestCharged" :: NullOrUndefined.NullOrUndefined (RequestCharged) } -> {"ServerSideEncryption" :: NullOrUndefined.NullOrUndefined (ServerSideEncryption) , "ETag" :: NullOrUndefined.NullOrUndefined (ETag) , "SSECustomerAlgorithm" :: NullOrUndefined.NullOrUndefined (SSECustomerAlgorithm) , "SSECustomerKeyMD5" :: NullOrUndefined.NullOrUndefined (SSECustomerKeyMD5) , "SSEKMSKeyId" :: NullOrUndefined.NullOrUndefined (SSEKMSKeyId) , "RequestCharged" :: NullOrUndefined.NullOrUndefined (RequestCharged) } ) -> UploadPartOutput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newUploadPartRequest' :: BucketName -> ObjectKey -> PartNumber -> MultipartUploadId -> ( { "Body" :: NullOrUndefined.NullOrUndefined (Body) , "Bucket" :: (BucketName) , "ContentLength" :: NullOrUndefined.NullOrUndefined (ContentLength) , "ContentMD5" :: NullOrUndefined.NullOrUndefined (ContentMD5) , "Key" :: (ObjectKey) , "PartNumber" :: (PartNumber) , "UploadId" :: (MultipartUploadId) , "SSECustomerAlgorithm" :: NullOrUndefined.NullOrUndefined (SSECustomerAlgorithm) , "SSECustomerKey" :: NullOrUndefined.NullOrUndefined (SSECustomerKey) , "SSECustomerKeyMD5" :: NullOrUndefined.NullOrUndefined (SSECustomerKeyMD5) , "RequestPayer" :: NullOrUndefined.NullOrUndefined (RequestPayer) } -> {"Body" :: NullOrUndefined.NullOrUndefined (Body) , "Bucket" :: (BucketName) , "ContentLength" :: NullOrUndefined.NullOrUndefined (ContentLength) , "ContentMD5" :: NullOrUndefined.NullOrUndefined (ContentMD5) , "Key" :: (ObjectKey) , "PartNumber" :: (PartNumber) , "UploadId" :: (MultipartUploadId) , "SSECustomerAlgorithm" :: NullOrUndefined.NullOrUndefined (SSECustomerAlgorithm) , "SSECustomerKey" :: NullOrUndefined.NullOrUndefined (SSECustomerKey) , "SSECustomerKeyMD5" :: NullOrUndefined.NullOrUndefined (SSECustomerKeyMD5) , "RequestPayer" :: NullOrUndefined.NullOrUndefined (RequestPayer) } ) -> UploadPartRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newVersioningConfiguration' :: ( { "MFADelete" :: NullOrUndefined.NullOrUndefined (MFADelete) , "Status" :: NullOrUndefined.NullOrUndefined (BucketVersioningStatus) } -> {"MFADelete" :: NullOrUndefined.NullOrUndefined (MFADelete) , "Status" :: NullOrUndefined.NullOrUndefined (BucketVersioningStatus) } ) -> VersioningConfiguration
...
--   This may be useful if you need to immediately overwrite some of the optional values
newWebsiteConfiguration' :: ( { "ErrorDocument" :: NullOrUndefined.NullOrUndefined (ErrorDocument) , "IndexDocument" :: NullOrUndefined.NullOrUndefined (IndexDocument) , "RedirectAllRequestsTo" :: NullOrUndefined.NullOrUndefined (RedirectAllRequestsTo) , "RoutingRules" :: NullOrUndefined.NullOrUndefined (RoutingRules) } -> {"ErrorDocument" :: NullOrUndefined.NullOrUndefined (ErrorDocument) , "IndexDocument" :: NullOrUndefined.NullOrUndefined (IndexDocument) , "RedirectAllRequestsTo" :: NullOrUndefined.NullOrUndefined (RedirectAllRequestsTo) , "RoutingRules" :: NullOrUndefined.NullOrUndefined (RoutingRules) } ) -> WebsiteConfiguration
